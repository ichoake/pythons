"""
Media Processing Image Dalle 2

This module provides functionality for media processing image dalle 2.
...
for idx, row in tqdm(df.iterrows(), total=df.shape[0]):
    ...
    description = row["description"] if row["description"] != "-" else generate_content(prompt)
