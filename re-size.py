...
ASPECT_RATIO_MINIMUMS = {
    ...
    "3:4": (CONSTANT_768, CONSTANT_1024),     # Portrait typically used for photography
    "4:3": (CONSTANT_1200, CONSTANT_1600),    # Common ratio in screens and photography
    "2:1": (CONSTANT_720, CONSTANT_1440),     # Wide aspect ratio
    "1:2": (CONSTANT_720, CONSTANT_360),      # Tall aspect ratio
}

# Example use to verify
for ratio, dimensions in ASPECT_RATIO_MINIMUMS.items():
    logger.info(f"Aspect Ratio {ratio}: Minimum dimensions {dimensions[0]}x{dimensions[1]}")
...
def get_closest_aspect_ratio(width, height):
    aspect_ratios = {
        ...
        "9:16": 9 / 16,
        "1:1": 1 / 1,
        "3:4": 3 / 4,     # Portrait typically used for photography
        "4:3": 4 / 3,     # Common ratio in screens and photography
        "2:1": 2 / 1,     # Wide aspect ratio
        "1:2": 1 / 2,     # Tall aspect ratio
    }
