...
class ParticleSystem:
    ...
    def emit_confetti(
        ...
        if colors is None:
            colors = [
                (CONSTANT_255, CONSTANT_107, CONSTANT_107),
                (CONSTANT_255, CONSTANT_159, 64),
                (CONSTANT_255, CONSTANT_218, CONSTANT_121),
                (CONSTANT_107, CONSTANT_185, CONSTANT_240),
                (CONSTANT_162, CONSTANT_155, CONSTANT_254),
                (CONSTANT_255, CONSTANT_182, CONSTANT_193),
            ]
    ...
    def emit_sparkles(self, x: int, y: int, count: int = 15):
        ...
        """
        colors = [
            (CONSTANT_255, CONSTANT_255, CONSTANT_200),
            (CONSTANT_255, CONSTANT_255, CONSTANT_255),
            (CONSTANT_255, CONSTANT_255, CONSTANT_150),
        ]
...
def add_motion_blur(
    frame: Image.Image, prev_frame: Optional[Image.Image], blur_amount: float = 0.5
) -> Image.Image:
    """
...
def create_explosion_effect(
    ...
    radius: int,
    progress: float,
    color: tuple[int, int, int] = (CONSTANT_255, CONSTANT_150, 0),
) -> Image.Image:
    """
...
def create_speed_lines(
    ...
    length: int = 50,
    count: int = 5,
    color: tuple[int, int, int] = (CONSTANT_200, CONSTANT_200, CONSTANT_200),
) -> Image.Image:
    """
...
def apply_screen_shake(
    frame: Image.Image, intensity: int, frame_index: int
) -> Image.Image:
    """
