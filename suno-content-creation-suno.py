...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Extract song rows from a Suno-like grid HTML into CSV."
    )
    ...
    parser.add_argument(
        ...
        "-o",
        type=Path,
        default=Path("songs_extracted.csv"),
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Join relative href/src with this base URL",
    )
...
def main():
    ...
    df = pd.DataFrame(
        rows, columns=["CoverUrl", "SongTitle", "SongURL", "Time", "Keys"]
    )
