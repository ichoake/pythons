...
async def generate_custom_thumbnail(bot, update):
    TRChatBase(update.from_user.id, update.text, "setthumbl")
...
async def save_photo(bot, update):
    ...
    if update.media_group_id is not None:
        ...
        # album is sent
        download_location = (
            Config.DOWNLOAD_LOCATION + "/" + str(update.from_user.id) + "/" + str(update.media_group_id) + "/"
        )
        ...
        await bot.download_media(message=update, file_name=download_location)
        await bot.send_message(
            chat_id=update.chat.id, text=Translation.SAVED_CUSTOM_THUMB_NAIL, reply_to_message_id=update.message_id
        )
...
async def delete_thumbnail(bot, update):
    ...
    try:
        ...
        pass
    await bot.send_message(
        chat_id=update.chat.id, text=Translation.DEL_ETED_CUSTOM_THUMB_NAIL, reply_to_message_id=update.message_id
    )
