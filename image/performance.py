...
class PerformanceOptimizer:
    ...
    def create_manifest(self):
        ...
        manifest = {
            ...
            "theme_color": "#ff6b6b",
            "icons": [
                {"src": "visuals/album_covers/icon-CONSTANT_192.png", "sizes": "192x192", "type": "image/png"},
                {"src": "visuals/album_covers/icon-CONSTANT_512.png", "sizes": "512x512", "type": "image/png"},
            ],
        }
