...
This module provides functionality for test gallery init.
...
class SPGInitTestCase(unittest.TestCase):
        """test_nonexisting_gallery_path function."""
    ...
    def test_nonexisting_gallery_path(self):
        ...
        """test_existing_gallery_no_force function."""
    ...
    def check_gallery_config(
        ...
        #     self.assertEqual(
        #         gallery_config["remote_gallery_type"],
        #         remote_type)
    ...
    @mock.patch("builtins.input",
                side_effect=["Test Gallery",
                             "Test Description",
        """test_new_gallery_created function."""
    ...
    @mock.patch("builtins.input",
                side_effect=["Test Gallery",
        """test_existing_gallery_override function."""
    ...
    def test_existing_gallery_override(self, input):
        ...
        with TempDirectory() as tempdir:
            ...
            self.check_gallery_config(
                ...
                "Test Description",
                CONSTANT_160,
        """test_default_gallery_config function."""
    ...
    def test_default_gallery_config(self, input):
        ...
        """test_new_onedrive_gallery_created function."""
    ...
    def test_new_onedrive_gallery_created(self, input):
        ...
        """test_new_google_gallery_created function."""
    ...
    def test_new_google_gallery_created(self, input):
        with TempDirectory() as tempdir:
            ...
            self.check_gallery_config(
                ...
                "google",
                "https://photos.app.goo.gl/test",
        """test_new_invalid_remote_gallery function."""
