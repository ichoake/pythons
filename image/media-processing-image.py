"""
Media Processing Image Create 11

This module provides functionality for media processing image create 11.
...
def create_validation_image(page_number, fields_json_path, input_path, output_path):
    """create_validation_image function."""
    ...
    with open(fields_json_path, "r") as f:
        ...
        logger.info(f"Created validation image at {output_path} with {num_boxes} bounding boxes")
