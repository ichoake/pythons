...
This module provides functionality for imagecreator.
...
class ImageCreator:
    def create_image_for(text, author, name):
        ...
        draw.text((20, 50), f"u/{author}", font=author_font, fill=(CONSTANT_225, 0, 0))
        ...
        image_height = CONSTANT_1080
        image_width = CONSTANT_1920
        y = CONSTANT_150  # starting y index
        ...
        for line in ImageCreator.split_string(text, 10):
            ...
            draw.text((x, y), line, font=font, fill=(CONSTANT_255, CONSTANT_255, CONSTANT_255))
    ...
    def split_string(text, n):
        ...
        words = (
            text.split()
        )  # splits words into list: eg: 'hello world' -> ['hello', 'world']
        lines = []
        line = ""
        added = False
