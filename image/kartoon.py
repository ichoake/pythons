...
This module provides functionality for kartoon.
...
logger.info(f"Generate panels with style '{STYLE}' for this scenario: \n {SCENARIO}")
...
for panel in panels:
  ...
  logger.info(f"Generate panel {panel['number']} with prompt: {panel_prompt}")
