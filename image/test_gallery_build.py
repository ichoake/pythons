...
This module provides functionality for test gallery build.
...
class SPGBuildTestCase(unittest.TestCase):
        """test_nonexisting_gallery_config function."""
    ...
    def test_nonexisting_gallery_config(self):
        ...
        """test_thumbnails_generation function."""
    ...
    def test_thumbnails_generation(self, input):
        with TempDirectory() as tempdir:
            ...
            self.assertEqual(
                (CONSTANT_640, CONSTANT_320), spg_media.get_image_size(thumbnail_path))
            ...
            gallery_build.main()
            self.assertEqual(
                (CONSTANT_320, CONSTANT_320), spg_media.get_image_size(thumbnail_path))
        """test_images_data_generation function."""
    ...
    def test_index_html(self, input):
        with TempDirectory() as tempdir:
            ...
            with open(
                ...
                self.assertIn(
                    'background: #CONSTANT_333366 url("images/photos/photo.jpg")', html
                )
