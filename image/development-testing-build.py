"""
Development Testing Pip Build Environment V2

This module provides functionality for development testing pip build environment v2.
...
class GalleryLogicTestCase(unittest.TestCase):
    def test_get_gallery_logic(self):
        """test_get_gallery_logic function."""
        ...
        """test_get_gallery_type function."""

    def test_get_gallery_type(self):
        link_type_mapping = [
            # OneDrive
            (
                "https://onedrive.live.com/?authkey=%21ABCDabcd123456789&id=12345678ABCDEFGH%CONSTANT_12345&cid=ABCDEFGH12345678",
                "onedrive",
            ),
