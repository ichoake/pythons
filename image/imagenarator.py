...
def imagemaker(theme, reddit_obj: dict, txtclr, padding=5, transparent=False) -> None:
    ...
    if transparent:
        font = ImageFont.truetype(os.path.join("fonts", "Roboto-Bold.ttf"), CONSTANT_100)
        tfont = ImageFont.truetype(os.path.join("fonts", "Roboto-Bold.ttf"), CONSTANT_100)
    else:
        tfont = ImageFont.truetype(os.path.join("fonts", "Roboto-Bold.ttf"), CONSTANT_100)  # for title
        font = ImageFont.truetype(os.path.join("fonts", "Roboto-Regular.ttf"), CONSTANT_100)
    size = (CONSTANT_1920, CONSTANT_1080)
