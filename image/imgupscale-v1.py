...
This module provides functionality for imgupscale.
...
- /Users/steven/Music/nocTurneMeLoDieS/python/FINAL_ORGANIZED/generation/imgupscale.py
- /Users/steven/Music/nocTurneMeLoDieS/python/CLEAN_ORGANIZED/generation/imgupscale.py
        ...
        if filename.lower().endswith((".png", ".jpeg", ".jpg")):
            ...
            try:
                ...
                with Image.open(source_file) as im:
                    ...
                    im_resized.save(destination_file, format=im.format, dpi=(CONSTANT_300, CONSTANT_300))

                    # Check file size and reduce quality if needed
                    file_size = os.path.getsize(destination_file) / (CONSTANT_1024 * CONSTANT_1024)  # size in MB
                    if file_size > max_size_mb:
                        for quality in range(95, 10, -5):  # Reduce quality in steps
                            ...
                            file_size = os.path.getsize(destination_file) / (CONSTANT_1024 * CONSTANT_1024)
                            if file_size <= max_size_mb:
                                break

                print(f"Converted, upscaled, and saved: {filename} -> {filename_no_ext}.{ext}")
...
def main():
    ...
    source_directory = input("Enter the path to the source directory containing PNG and JPEG images: ")
