"""
Web Scraping Download News Api Fetcher V2

This module provides functionality for web scraping download news api fetcher v2.
...
def get_closest_aspect_ratio(width, height):
    ...
    closest_ratio = min(
        ASPECT_RATIOS,
        key=lambda ar: abs(current_ratio - (ASPECT_RATIOS[ar][0] / ASPECT_RATIOS[ar][1])),
    )
