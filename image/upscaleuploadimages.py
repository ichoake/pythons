...
This module provides functionality for upscaleuploadimages.
...
for idx, row in image_df.iterrows():
    ...
    data = {
        ...
        "variants": [
            {"id": CONSTANT_71689, "price": CONSTANT_3999, "is_enabled": True}  # Replace with the actual variant ID
        ],
        "print_areas": [
            {
                "variant_ids": [CONSTANT_71689],  # Replace with the actual variant ID
                "placeholders": [
                    {"position": "front", "images": [{"id": image_id, "x": 0.5, "y": 0.5, "scale": 1.0, "angle": 0}]}
                ],
            }
        ],
    }
