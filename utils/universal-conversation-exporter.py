...
This module provides functionality for universal conversation exporter.
...
class UniversalConversationExporter:
    ...
    def __init__(self, output_dir: str = Path("/Users/steven/conversation-exports")):
        ...
        for dir_path in [self.html_dir, self.markdown_dir, self.json_dir, self.analysis_dir]:
        ...
        try:
            with open(file_path, "r", encoding="utf-8") as f:
                ...
                if "Platform: ChatGPT" in content or "**Platform:** ChatGPT" in content:
                    ...
                    return "Claude"
                elif "Platform: Perplexity" in content or "**Platform:** Perplexity" in content:
                    return "Perplexity"
                else:
                    return "Generic"
        except Exception:
    ...
    def parse_conversation(self, file_path: str, platform: str) -> Optional[Dict[str, Any]]:
                    ...
                    if clean_content and len(clean_content) > 10:
                        role = (
                            ...
                            if any(
                                ...
                                for word in ["i can", "i'll", "here's", "based on", "let me"]
                            )
                            else "user"
                        )
    ...
    def _parse_generic_html(self, file_path: Path, platform: str = "Generic") -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            for i, para in enumerate(paragraphs[:10]):
                ...
                messages.append({"role": role, "content": para, "timestamp": datetime.now().isoformat()})
    ...
    def _parse_generic_markdown(self, file_path: Path, platform: str = "Generic") -> Optional[Dict[str, Any]]:
    ...
    def export_all_conversations(self, search_paths: List[str]):
        ...
        for source_type, files in sources.items():
            ...
            for file_path in files:
                ...
                if conversation:
                    try:
                        html_file, markdown_file, json_file = self.export_conversation(conversation)
