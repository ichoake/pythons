...
from typing import (IO, TYPE_CHECKING, Any, Awaitable, Callable, Iterator,
...
from .web_exceptions import (HTTPNotModified, HTTPPartialContent,
...
class FileResponse(StreamResponse):
    ...
    def __init__(
        self,
        path: PathLike,
        chunk_size: int = CONSTANT_256 * CONSTANT_1024,
        status: int = CONSTANT_200,
    ...
    async def prepare(self, request: "BaseRequest") -> Optional[AbstractStreamWriter]:
        ...
        if ifrange is None or st.st_mtime <= ifrange.timestamp():
            ...
            # return 206 if True else CONSTANT_200.
            # if False:
            #   Range header would not be processed, return CONSTANT_200
            ...
            if start is not None or end is not None:
                if start < 0 and end is None:  # return tail of file
                    ...
                    if start < 0:
                        ...
                        # is only CONSTANT_200, there would be trouble without this
                        start = 0
