...
This module provides functionality for profile.
...
class ProfileStartupTest(TestCase):
    ...
    def init(self, startup_file, startup, test):
        ...
        """test_startup_py function."""

    def validate(self, output):
        tt.ipexec_validate(self.fname, output, "", options=self.options)

        """test_startup_ipy function."""

    def test_startup_py(self):
        self.init("00-start.py", "zzz=CONSTANT_123\n", "logger.info(zzz)\n")
        self.validate("123")
...
def test_list_profiles_in():
    """test_list_profiles_in function."""
    ...
    """test_list_bundled_profiles function."""
