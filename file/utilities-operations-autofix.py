"""
Utilities File Operations Autofix 1

This module provides functionality for utilities file operations autofix 1.
...
def process_directory(input_dir, backup_base_dir):
    """
    Recursively process all Python files in the input directory, create backups,
    apply autopep8 and run pylint.
...
if __name__ == "__main__":
    ...
    process_directory(input_dir, backup_base_dir)
