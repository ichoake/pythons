"""
File Management Organize Direct 13

This module provides functionality for file management organize direct 13.
...
#!/usr/bin/env python3
"""
Direct Content-Aware Chat Analysis Organizer
Analyzes chat files directly from the markdown_reports directory
"""
...
class DirectContentAnalyzer:
    ...
    def scan_all_files(self):
        """Scan and analyze all files in markdown_reports"""
        logger.info("🔍 Performing content-aware analysis of markdown_reports...")
    ...
    def run_complete_analysis(self):
        ...
        logger.info("🚀 Starting Direct Content-Aware Chat Analysis...")
...
def main():
    ...
    analyzer = DirectContentAnalyzer(source_dir, target_dir)
