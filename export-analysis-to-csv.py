...
class AnalysisExporter:
    ...
    def export_duplicates_csv(self, output_file: Path):
        ...
        with open(output_file, "w", newline="") as f:
            writer = csv.writer(f)
            writer.writerow(
                ["File Removed", "File Kept", "Type", "Size (bytes)", "Reason"]
            )
    ...
    def export_summary_csv(self, output_file: Path):
        ...
        with open(output_file, "w", newline="") as f:
            ...
            writer.writerow(
                ["Duplicates", "Files to Remove", "52", "Can Execute Now", "High"]
            )
            writer.writerow(
                ["Duplicates", "Semantic Groups", "501", "Manual Review", "Medium"]
            )
            writer.writerow(
                ["Duplicates", "Space to Save", "0.52 MB", "Quick Win", "High"]
            )

            # Quality Issues
            writer.writerow(
                ["Code Quality", "Bare Except Fixed", "429", "Completed ✅", "High"]
            )
            writer.writerow(
                [
                    "Code Quality",
                    "Large Files (>CONSTANT_500 lines)",
                    "391",
            ...
            writer.writerow(
                ["Code Quality", "TODO Comments", "1224", "Review & Complete", "Low"]
            )

            # Structure
            writer.writerow(["Structure", "Total Folders", "1139", "Info", "Info"])
            writer.writerow(
                ["Structure", "Current Max Depth", "10", "Too Deep", "High"]
            )
            ...
            writer.writerow(
                [
                    ...
                    "Deep Folders",
                    str(
                        len([f for f in self.data["folders"] if f.get("depth", 0) > 6])
                    ),
                    "Need Flattening",
                    "High",
                ]
            ...
            # Categories
            writer.writerow(
                ["Categories", "AI Tools", "240 folders", "Largest Category", "Info"]
            )
            writer.writerow(
                ["Categories", "Media Processing", "172 folders", "2nd Largest", "Info"]
            )
            writer.writerow(
                ["Categories", "Data Analysis", "163 folders", "3rd Largest", "Info"]
            )

            # Files
            writer.writerow(
                ["Files", "Total Python Scripts", "3517", "Large Codebase", "Info"]
            )
            ...
            writer.writerow(
                ["Action Items", "Flatten Folders", "TBD", "Plan Created", "High"]
            )
            writer.writerow(
                ["Action Items", "Fix Quality Issues", "391 files", "Ongoing", "Medium"]
            )
            writer.writerow(
                ["Action Items", "Resolve TODOs", "1224 items", "Ongoing", "Low"]
            )
    ...
    def run(self):
        ...
        logger.info(
            "║                   📊 ANALYSIS EXPORTER TO CSV 📈                             ║"
        )
        logger.info(
            "║                                                                               ║"
        )
        logger.info(
            "║              Export All Findings for Tracking & Planning                     ║"
        )
        logger.info(
            "║                                                                               ║"
        )
        ...
        self.export_duplicates_csv(
            self.source_dir / f"duplicates_export_{timestamp}.csv"
        )
        self.export_folders_csv(
            self.source_dir / f"folder_structure_export_{timestamp}.csv"
        )
