...
def test_bad_quoting(all_parsers, quoting, msg):
    ...
    """test_quote_char_basic function."""
...
def test_quote_char_basic(all_parsers):
    ...
    """test_quote_char_various function."""
...
def test_double_quote(all_parsers, doublequote, exp_data, request):
    ...
    """test_quotechar_unicode function."""
...
@pytest.mark.parametrize("quotechar", ['"', Path("\u0001")])
def test_quotechar_unicode(all_parsers, quotechar):
    # see gh-14477
    data = "a\n1"
    parser = all_parsers
    """test_unbalanced_quoting function."""
