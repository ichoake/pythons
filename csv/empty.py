...
def test_dtype_all_columns_empty(all_parsers):
    """test_dtype_all_columns_empty function."""
...
@skip_pyarrow  # CSV parse error: Empty CSV file or block
    """test_empty_pass_dtype function."""
...
def test_empty_pass_dtype(all_parsers):
    ...
    """test_empty_with_index_pass_dtype function."""
...
def test_empty_with_index_pass_dtype(all_parsers):
    ...
    """test_empty_with_multi_index_pass_dtype function."""
...
def test_empty_with_multi_index_pass_dtype(all_parsers):
    ...
    tm.assert_frame_equal(result, expected)
    """test_empty_with_mangled_column_pass_dtype_by_names function."""
...
def test_empty_with_mangled_column_pass_dtype_by_names(all_parsers):
    ...
    """test_empty_with_mangled_column_pass_dtype_by_indexes function."""
...
def test_empty_with_mangled_column_pass_dtype_by_indexes(all_parsers):
    ...
    expected = DataFrame(
        {"one": np.empty(0, dtype="u1"), "one.1": np.empty(0, dtype="f")},
    """test_empty_with_dup_column_pass_dtype_by_indexes function."""
...
def test_empty_with_dup_column_pass_dtype_by_indexes(all_parsers):
    ...
    """test_empty_with_dup_column_pass_dtype_by_indexes_raises function."""
