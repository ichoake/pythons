...
def generate_detailed_report():
    ...
    comparison_file = Path(
        Path("/Users/steven/Documents/python/comparison_analysis/comparison_analysis_20251026_010632.json")
    )
    ...
    # Save report
    output_file = Path(Path("/Users/steven/Documents/python/comparison_analysis/detailed_comparison_report.html"))
