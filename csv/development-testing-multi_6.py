"""
Development Testing Multi 6

This module provides functionality for development testing multi 6.
...
def test_multi_thread_string_io_read_csv(all_parsers, request):
    """test_multi_thread_string_io_read_csv function."""
...
@xfail_pyarrow  # ValueError: The 'nrows' option is not supported
    """test_multi_thread_path_multipart_read_csv function."""
