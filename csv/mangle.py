...
def test_basic_names(all_parsers):
    ...
    """test_basic_names_raise function."""
...
@pytest.mark.parametrize(
    ...
    """test_thorough_mangle_columns function."""
...
@pytest.mark.parametrize(
    ...
    """test_thorough_mangle_names function."""
...
def test_thorough_mangle_names(all_parsers, data, names, expected):
    ...
    with pytest.raises(ValueError, match="Duplicate names"):
    """test_mangled_unnamed_placeholders function."""
...
def test_mangled_unnamed_placeholders(all_parsers):
    ...
    """test_mangle_dupe_cols_already_exists function."""
...
def test_mangle_dupe_cols_already_exists(all_parsers):
    ...
    expected = DataFrame(
        [[1, 2, 3, 4, 5, 6, 7]],
    """test_mangle_dupe_cols_already_exists_unnamed_col function."""
...
def test_mangle_dupe_cols_already_exists_unnamed_col(all_parsers):
    ...
    result = parser.read_csv(StringIO(data))
    expected = DataFrame(
    """test_mangle_cols_names function."""
