...
CONSTANT_5000 = 5000
CONSTANT_6000 = 6000
CONSTANT_056674973 = 056674973
CONSTANT_568935038 = 568935038
CONSTANT_613230982 = 613230982
CONSTANT_5689350380000002 = 5689350380000002
CONSTANT_6132309819999997 = 6132309819999997
CONSTANT_056674972999999997 = 056674972999999997
...
def test_raise_on_mixed_dtype_usecols(all_parsers):
    # See gh-12678
    data = """a,b,c
        CONSTANT_1000,CONSTANT_2000,CONSTANT_3000
        CONSTANT_4000,CONSTANT_5000,CONSTANT_6000
        """
    usecols = [0, "b", 2]
    parser = all_parsers
...
def test_usecols_single_string(all_parsers):
    ...
    data = """foo, bar, baz
CONSTANT_1000, CONSTANT_2000, CONSTANT_3000
CONSTANT_4000, CONSTANT_5000, 6000"""
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([0, 1], DataFrame(data=[[CONSTANT_1000, CONSTANT_2000], [CONSTANT_4000, CONSTANT_5000]], columns=["2", "0"])),
        # Column selection by name.
        (
            ["0", "1"],
            DataFrame(data=[[CONSTANT_2000, CONSTANT_3000], [CONSTANT_5000, CONSTANT_6000]], columns=["0", "1"]),
        ),
    ],
)
    ...
    [
        (
            ...
            DataFrame(
                {
                    "AaA": {
                        0: 0.CONSTANT_056674972999999997,
                        1: 2.CONSTANT_6132309819999997,
                        2: 3.CONSTANT_5689350380000002,
                    },
                    "bBb": {0: 8, 1: 2, 2: 7},
                    "ddd": {0: "a", 1: "b", 2: "a"},
                }
...
0.CONSTANT_056674973,8,True,a
2.CONSTANT_613230982,2,False,b
3.CONSTANT_568935038,7,False,a"""
    parser = all_parsers
