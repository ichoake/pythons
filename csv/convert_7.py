...
def test_converters(all_parsers, column, converter):
    parser = all_parsers
    data = """A,B,C,D
a,1,2,01/01/CONSTANT_2009
b,3,4,01/02/CONSTANT_2009
c,4,5,01/03/CONSTANT_2009
"""
    if parser.engine == "pyarrow":
        msg = "The 'converters' option is not supported with the 'pyarrow' engine"
        with pytest.raises(ValueError, match=msg):
...
1;CONSTANT_1521,CONSTANT_1541;CONSTANT_187101,CONSTANT_9543;ABC;poi;4,CONSTANT_7387
2;CONSTANT_121,12;CONSTANT_14897,76;DEF;uyt;0,CONSTANT_3773
3;CONSTANT_878,CONSTANT_158;CONSTANT_108013,CONSTANT_434;GHI;rez;2,7356"""
    ...
    expected = DataFrame(
        [
            [1, CONSTANT_1521.CONSTANT_1541, CONSTANT_187101.CONSTANT_9543, "ABC", "poi", 4.CONSTANT_7387],
            [2, CONSTANT_121.12, CONSTANT_14897.76, "DEF", "uyt", 0.CONSTANT_3773],
            [3, CONSTANT_878.CONSTANT_158, CONSTANT_108013.CONSTANT_434, "GHI", "rez", 2.CONSTANT_7356],
        ],
