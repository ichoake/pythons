...
This module provides functionality for emotional.
...
class EmotionalQuizGenerator:
    def __init__(self, api_key):
        ...
        self.quiz_emotions = {
            "excited": {"rate": "fast", "pitch": "high", "volume": "loud", "description": "Energetic and enthusiastic"},
            "mysterious": {
                "rate": "slow",
                "pitch": "low",
                "volume": "medium",
            ...
            "dramatic": {"rate": "medium", "pitch": "high", "volume": "loud", "description": "Theatrical and engaging"},
            "calm": {"rate": "slow", "pitch": "low", "volume": "medium", "description": "Relaxed and thoughtful"},
        }
    ...
    def generate_emotional_quiz_speech(
        self, question, options, correct_answer, output_path, emotion="excited", voice="alloy"
    ):
        """
        ...
        try:
            ...
            if response.status_code == CONSTANT_200:
                ...
                logger.info(f"✅ Generated emotional quiz: {os.path.basename(output_path)}")
                return True
            else:
                logger.info(f"❌ Failed to generate speech: {response.status_code} {response.text}")
                return False
    ...
    def process_quiz_with_emotions(self, csv_path, output_folder):
        ...
        for i, row in enumerate(questions):
            ...
            if self.generate_emotional_quiz_speech(question, options, correct_answer, output_path, emotion, voice):
