        ...
        try:
            with open(file_path, 'r', encoding='utf-8') as f:
                ...
                return any(indicator in content for indicator in [
                    ...
                    'perplexity.ai', 'Perplexity', 'conversation', 'message',
                    'data-theme="dark"', 'hljs.highlightAll()'
                ])
...
def main():
    ...
    parser.add_argument('--output-dir', default='/Users/steven/conversation-exports',
