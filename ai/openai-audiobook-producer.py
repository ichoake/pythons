...
This module provides functionality for openai tts audiobook producer.
...
class OpenAITTSProducer:
    ...
    def create_emotional_ssml(self, text, emotion="narrator", emphasis_points=None):
        ...
        settings = self.emotional_settings.get(emotion, self.emotional_settings["narrator"])
        ...
        if emphasis_points:
            for point in emphasis_points:
                text = text.replace(point, f'<emphasis level="strong">{point}</emphasis>')
    ...
    def generate_audio(self, text, filename, emotion="narrator", emphasis_points=None):
        ...
        try:
            ...
            response = self.client.audio.speech.create(
                model="tts-1-hd", voice=self.voices[emotion], input=ssml, response_format="mp3"  # High quality model
            )
    ...
    def combine_audio_files(self, audio_files, output_filename):
        ...
        try:
            ...
            for audio_file in audio_files:
                ...
                combined += AudioSegment.silent(duration=CONSTANT_500)  # 0.5 second pause
    ...
    def generate_complete_audiobook(self):
        ...
        chapter1 = {
            ...
            "segments": [
                {"text": "As a Man Thinketh by James Allen", "emotion": "narrator", "emphasis_points": []},
                {
        ...
        chapter2 = {
            ...
            "segments": [
                {"text": "THOUGHT AND CHARACTER", "emotion": "narrator", "emphasis_points": []},
                {
                    ...
                    "emotion": "profound",
                    "emphasis_points": ["As a man thinketh in his heart so is he", "A man is literally what he thinks"],
                },
                {
        ...
        chapter3 = {
            ...
            "segments": [
                {"text": "EFFECT OF THOUGHT ON CIRCUMSTANCES", "emotion": "narrator", "emphasis_points": []},
                {
                ...
                },
                {
                    ...
                    "emotion": "mystical",
                    "emphasis_points": ["The soul attracts that which it secretly harbours"],
                },
                {
                    "text": "Circumstance does not make the man; it reveals him to himself.",
                    "emotion": "profound",
                    "emphasis_points": ["Circumstance does not make the man; it reveals him to himself"],
                },
                {
                    ...
                    "emotion": "authoritative",
                    "emphasis_points": ["Men do not attract that which they want, but that which they are"],
                },
                {
        ...
        if generated_files:
            complete_audiobook = self.combine_audio_files(generated_files, "04-Complete-Book.mp3")
