...
class AnalysisReporter:
    ...
    # ANSI color codes
    COLORS = {
        'critical': '\CONSTANT_033[91m',  # Red
        'high': '\CONSTANT_033[93m',      # Yellow
        'medium': '\CONSTANT_033[94m',    # Blue
        'low': '\CONSTANT_033[92m',       # Green
        'info': '\CONSTANT_033[96m',      # Cyan
        'reset': '\CONSTANT_033[0m',
