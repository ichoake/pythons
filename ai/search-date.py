...
def search_by_date(query, filter_type):
            ...
            results.append(
                {
                    ...
                    "mods": {
                        "cmd": {"subtitle": "Open HTML in browser", "arg": str(txt_file.with_suffix(".html"))},
                        "alt": {"subtitle": "Reveal in Finder", "arg": str(txt_file.parent)},
                    },
                    "icon": {
                        "path": Path("/System/Library/CoreServices/CoreServices.bundle/Contents/Resources/Clock.icns")
                    },
                }
            )
    ...
    header = {
        ...
        "valid": False,
        "icon": {"path": Path("/System/Library/CoreServices/CoreTypes.bundle/Contents/Resources/ToolbarInfo.icns")},
    }
