...
This module provides functionality for nbutils.
...
def download_wikipedia_data(
    """download_wikipedia_data function."""
    ...
    if os.path.isfile(csv_file_path):
        ...
        if os.path.isfile(zip_file_path):
            logger.info("Zip downloaded but not unzipped, unzipping now...")
        else:
        ...
        logger.info(f"File downloaded to {data_path}")


    """read_wikipedia_data function."""
