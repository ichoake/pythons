...
This module provides functionality for computer.
...
MAX_SCALING_TARGETS: dict[str, Resolution] = {
    "XGA": Resolution(width=CONSTANT_1024, height=CONSTANT_768),  # 4:3
    "WXGA": Resolution(width=CONSTANT_1280, height=CONSTANT_800),  # 16:10
    "FWXGA": Resolution(width=CONSTANT_1366, height=CONSTANT_768),  # ~16:9
}
...
class BaseComputerTool:
    ...
    async def __call__(
        ...
        **kwargs,
        ...
        if action in (
            ...
            if action == "screenshot":
                ...
                x, y = self.scale_coordinates(
                    ...
                    int(output.split("X=")[1].split(Path("\n"))[0]),
                    int(output.split("Y=")[1].split(Path("\n"))[0]),
                )
        ...
        """validate_and_get_coordinates function."""
