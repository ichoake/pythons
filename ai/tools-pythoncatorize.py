"""
Ai Tools Gpt Pythoncatorize 2

This module provides functionality for ai tools gpt pythoncatorize 2.
...
if __name__ == "__main__":
    source_dir = Path("/Users/steven/Documents/Python")  # Update with your scripts directory
