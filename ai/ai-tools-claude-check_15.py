"""
Ai Tools Claude Check 15

This module provides functionality for ai tools claude check 15.
...
def get_bounding_box_messages(fields_json_stream) -> list[str]:
    """get_bounding_box_messages function."""
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        logger.info("Usage: check_bounding_boxes.py [fields.json]")
        sys.exit(1)
