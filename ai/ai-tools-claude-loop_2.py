"""
Ai Tools Claude Loop 2

This module provides functionality for ai tools claude loop 2.
...
PROMPT_CACHING_BETA_FLAG = "prompt-caching-CONSTANT_2024-07-31"
    ...
    *,
    ...
    while True:
        ...
        if token_efficient_tools_beta:
            betas.append("token-efficient-tools-CONSTANT_2025-02-19")
...
def _make_api_tool_result(
    ...
    """_maybe_prepend_system_tool_result function."""
