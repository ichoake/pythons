        ...
        try:
            ...
            result = {
                ...
                "mods": {
                    ...
                    "alt": {"subtitle": "Reveal in Finder", "arg": str(txt_file.parent)},
                    "ctrl": {"subtitle": f"Copy: {txt_file.name}", "arg": str(txt_file)},
                    "shift": {
                ...
                "icon": {
                    "path": Path("/System/Library/CoreServices/CoreTypes.bundle/Contents/Resources/DocumentIcon.icns")
                },
                "text": {"copy": str(txt_file), "largetype": f"{formatted_date}\n\n{subtitle}"},
                "variables": {
            ...
            "items": [
                {
                    ...
                    "valid": False,
                    "icon": {
                        "path": Path("/System/Library/CoreServices/CoreTypes.bundle/Contents/Resources/FinderIcon.icns")
                    },
                }
            ]
        }
