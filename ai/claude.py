...
def main():
    ...
    # Parse arguments
    parser = argparse.ArgumentParser(description="Claude CLI - Ask Claude questions from terminal")
...
def ask_claude(client, question, model):
    ...
    try:
        response = client.messages.create(
            model=model, max_tokens=CONSTANT_4000, messages=[{"role": "user", "content": question}]
        )
