"""
Cloud Services Aws Streamlit 1

This module provides functionality for cloud services aws streamlit 1.
...
PROVIDER_TO_DEFAULT_MODEL_NAME: dict[APIProvider, str] = {
    ...
    APIProvider.BEDROCK: "anthropic.claude-3-5-sonnet-CONSTANT_20241022-v2:0",
...
SONNET_3_5_NEW = ModelConfig(
    ...
    max_output_tokens=CONSTANT_1024 * 8,
    default_output_tokens=CONSTANT_1024 * 4,
)

SONNET_3_7 = ModelConfig(
    tool_version="computer_use_20250124",
    max_output_tokens=128_000,
    default_output_tokens=CONSTANT_1024 * 16,
    has_thinking=True,
)
...
MODEL_TO_MODEL_CONF: dict[str, ModelConfig] = {
    ...
    "anthropic.claude-haiku-4-5-CONSTANT_20251001-v1:0": HAIKU_4_5,  # Bedrock
...
<style>
    ...
    button[kind=header] {
        background-color: rgb(CONSTANT_255, 75, 75);
        border: 1px solid rgb(CONSTANT_255, 75, 75);
        color: rgb(CONSTANT_255, CONSTANT_255, CONSTANT_255);
    }
    button[kind=header]:hover {
        background-color: rgb(CONSTANT_255, 51, 51);
    }
...
async def main():
    ...
    """maybe_add_interruption_blocks function."""
