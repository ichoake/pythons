"""
Ai Tools Claude Extract 7

This module provides functionality for ai tools claude extract 7.
    ...
    if ft == Path("/Tx"):
        ...
        if len(states) == 2:
            ...
            if Path("/Off") in states:
                field_dict["checked_value"] = states[0] if states[0] != Path("/Off") else states[1]
...
def get_field_info(reader: PdfReader):
        ...
        for ann in annotations:
            ...
            if field_id in field_info_by_id:
                ...
                try:
                    ...
                    on_values = [v for v in ann[Path("/AP")][Path("/N")] if v != Path("/Off")]
                except KeyError:
                    continue
                if len(on_values) == 1:
    ...
    for field_info in field_info_by_id.values():
        if "page" in field_info:
            ...
            logger.info(f"Unable to determine location for field id: {field_info.get('field_id')}, ignoring")
        """sort_key function."""
