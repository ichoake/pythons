...
This module provides functionality for message.
...
class TestMessageParams:
    ...
    def test_basic_agent(self) -> None:
        ...
        agent = Agent(name="BasicAgent", system="You are a helpful assistant. Be very brief.", verbose=False)
    ...
    def test_custom_headers(self) -> None:
        ...
        agent = Agent(
            ...
            verbose=False,
            message_params={"extra_headers": {"X-Custom-Header": "test-value", "X-Request-ID": "test-12345"}},
        )
    ...
    def test_beta_headers(self) -> None:
        ...
        agent = Agent(
            ...
            system="You are a helpful assistant. Be very brief.",
            verbose=False,
            message_params={"extra_headers": {"anthropic-beta": "files-api-CONSTANT_2025-04-14"}},
        )
    ...
    def test_parameter_override(self) -> None:
        ...
        config = ModelConfig(temperature=1.0, max_tokens=CONSTANT_100)
        ...
        agent = Agent(
            ...
            message_params={
                ...
                "max_tokens": CONSTANT_200,  # Should override config
            },
        )

        params = agent._prepare_message_params()
        assert params["temperature"] == 0.5
        assert params["max_tokens"] == CONSTANT_200
    ...
    def test_invalid_metadata_field(self) -> None:
        ...
        agent = Agent(
            ...
            system="You are a helpful assistant.",
            verbose=False,
            message_params={"metadata": {"user_id": "valid", "invalid_field": "should-fail"}},
        )
    ...
    def test_combined_parameters(self) -> None:
        ...
        agent = Agent(
            ...
            verbose=False,
            message_params={
                "extra_headers": {"X-Test": "combined", "anthropic-beta": "files-api-CONSTANT_2025-04-14"},
...
def main():
    ...
    if not os.environ.get("ANTHROPIC_API_KEY"):
        logger.info("Error: Please set ANTHROPIC_API_KEY environment variable")
        sys.exit(1)
