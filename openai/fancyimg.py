...
This module provides functionality for fancyimg.
...
# Example usage
directory = Path("/Volumes/Pics/steven/halloween")
output_csv = Path("/Volumes/Pics/steven/halloween/paired_output.csv")
