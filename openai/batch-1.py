...
This module provides functionality for batch img seo.
...
USER_TEXT_PROMPT = "Analyze this image and return the requested JSON fields. The image is provided above under 'image_url'."
...
def call_gpt4o(
    messages: List[Dict[str, Any]], model: str, max_tokens: int, temperature: float
) -> str:
    """
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--max_tokens",
        type=int,
        default=CONSTANT_1024,
        help="Max tokens for GPT-4o (default: CONSTANT_1024).",
    )
    parser.add_argument(
        "--temperature",
        type=float,
        default=0.7,
        help="Temperature for GPT-4o (default: 0.7).",
    )
