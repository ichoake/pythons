"""
Development Process Proc 30

This module provides functionality for development process proc 30.
...
class ExtractNews:
    ...
    def polly_tts(self, title, description, link, category, keywords):
        logging.info(
            f"inside polly_tts method title: {title} ,description: {description} "
        )
