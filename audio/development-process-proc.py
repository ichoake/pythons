"""
Development Process Proc 17

This module provides functionality for development process proc 17.
...
def create_audio(path, text):
    ...
    response = polly_client.synthesize_speech(Engine="neural", OutputFormat="mp3", Text=text, VoiceId="Matthew")
