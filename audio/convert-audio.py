...
This module provides functionality for convert to audio.
...
async def convert_to_audio(bot, update):
    ...
    if (update.reply_to_message is not None) and (update.reply_to_message.media is not None):
        ...
        await bot.send_message(
            chat_id=update.chat.id, text=Translation.REPLY_TO_DOC_FOR_C2V, reply_to_message_id=update.message_id
        )
