"""
Ytdl Ytdl Audiometadata

This module provides functionality for ytdl ytdl audiometadata.
...
class AudioMetadata(object):
    ...
    def __resize__(self, album_art_file):
        size = tuple([CONSTANT_1000, CONSTANT_1000])
        ...
        final_thumb = Image.new(mode="RGBA", size=size, color=(0, 0, 0, CONSTANT_255))
