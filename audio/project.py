...
class AvaTarArTsProjectManager:
    ...
    def __init__(self):
        ...
        self.projects = {
            "as_a_man_thinketh": {
                ...
                "output_dirs": ["as_a_man_thinketh_audio_mp3", "as_a_man_thinketh_visual_analysis"],
            },
            "grid_systems": {
                "name": "Grid Systems",
                "description": "Multi-grid file browser systems",
                "main_files": ["multi_grid_generator.py", "professional_grid_generator.py", "launch_professional.py"],
    ...
    def organize_existing_work(self, project_dir: Path):
        ...
        # Copy documentation
        doc_files = ["README.md", "ULTIMATE_README.md", "COMPLETE_PROJECT_SUMMARY.md", "AUDIO_SUMMARY.md"]
        ...
        grid_docs = ["MULTI_GRID_SUMMARY.md", "PROFESSIONAL_GRID_SUMMARY.md", "README_GRIDS.md"]
