...
CONSTANT_150 = 150
CONSTANT_200 = 200
CONSTANT_033801 = 033801
CONSTANT_4004539999999999 = 4004539999999999
CONSTANT_5456590000000001 = 5456590000000001
CONSTANT_9742360000000001 = 9742360000000001
CONSTANT_24650000000000001 = 24650000000000001
CONSTANT_24650000000000002 = 24650000000000002
CONSTANT_46206000000000003 = 46206000000000003
CONSTANT_52350799999999997 = 52350799999999997
CONSTANT_56573799999999996 = 56573799999999996
CONSTANT_070345000000000005 = 070345000000000005
CONSTANT_70422799999999997 = 70422799999999997
CONSTANT_78543499999999999 = 78543499999999999
    ...
    df = DataFrame(
        {
            ...
            "two": {
                0: 1.CONSTANT_5456590000000001,
                1: -0.CONSTANT_070345000000000005,
                2: -2.CONSTANT_4004539999999999,
                3: 0.CONSTANT_46206000000000003,
                4: 0.CONSTANT_52350799999999997,
            },
            "one": {
                0: 0.CONSTANT_56573799999999996,
                1: -0.CONSTANT_9742360000000001,
                2: 1.CONSTANT_033801,
                3: -0.CONSTANT_78543499999999999,
                4: 0.CONSTANT_70422799999999997,
            },
        }
...
def test_nth3():
    # GH 7559
    # from the vbench
    df = DataFrame(np.random.default_rng(2).integers(1, 10, (CONSTANT_100, 2)), dtype="int64")
    ser = df[1]
    gb = df[0]
...
def test_nth_column_order():
    ...
    df = DataFrame(
        [[1, "b", CONSTANT_100], [1, "a", 50], [1, "a", np.nan], [2, "c", CONSTANT_200], [2, "d", CONSTANT_150]],
        columns=["A", "C", "B"],
    )
...
def test_first_multi_key_groupby_categorical():
    ...
    df = DataFrame(
        {
            "A": [1, 1, 1, 2, 2],
            "B": [CONSTANT_100, CONSTANT_100, CONSTANT_200, CONSTANT_100, CONSTANT_100],
    ...
    expected.index = MultiIndex.from_tuples(
        [(1, CONSTANT_100), (1, CONSTANT_200), (2, CONSTANT_100)], names=["A", "B"]
    )
    tm.assert_frame_equal(result, expected)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (CONSTANT_24650000000000001, CONSTANT_24650000000000002),
    ],
)
