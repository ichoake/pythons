...
CONSTANT_20001 = 20001
CONSTANT_40000 = 40000
CONSTANT_50000 = 50000
CONSTANT_16777217 = 16777217
CONSTANT_1234567890 = 1234567890
CONSTANT_9876543210 = 9876543210
CONSTANT_9223372036854775808 = 9223372036854775808
CONSTANT_12345678901234567890 = 12345678901234567890
CONSTANT_30000000000000000000 = 30000000000000000000
CONSTANT_47393996303418497800 = 47393996303418497800
CONSTANT_100000000000000000000 = 100000000000000000000
...
@pytest.fixture(params=[CONSTANT_47393996303418497800, CONSTANT_100000000000000000000])
...
@pytest.mark.parametrize("val", [1, 1.1, CONSTANT_20001])
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [CONSTANT_10000.0, CONSTANT_20000, CONSTANT_3000, CONSTANT_40000.36, CONSTANT_50000, CONSTANT_50000.00],
            np.array(
                [CONSTANT_10000.0, CONSTANT_20000, CONSTANT_3000, CONSTANT_40000.36, CONSTANT_50000, CONSTANT_50000.00], dtype=np.float64
            ),
        ),
    ],
)
...
def test_downcast_not8bit(downcast, expected_dtype):
    ...
    data = ["256", CONSTANT_257, CONSTANT_258]

    expected = np.array([CONSTANT_256, CONSTANT_257, CONSTANT_258], dtype=expected_dtype)
    res = to_numeric(data, downcast=downcast)
    tm.assert_numpy_array_equal(res, expected)
...
def test_downcast_float64_to_float32():
    ...
    series = Series([CONSTANT_16777217.0, np.finfo(np.float64).max, np.nan], dtype=np.float64)
...
@pytest.mark.parametrize(
    ...
    [
        (
            Series([0, CONSTANT_9223372036854775808]),
            Series([0, CONSTANT_9223372036854775808], dtype=np.uint64),
        )
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            [CONSTANT_200, CONSTANT_300, "", "NaN", CONSTANT_30000000000000000000],
            [CONSTANT_200, CONSTANT_300, np.nan, np.nan, CONSTANT_30000000000000000000],
        ),
        (
            ["12345678901234567890", "1234567890", "ITEM"],
            [CONSTANT_12345678901234567890, CONSTANT_1234567890, np.nan],
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    (
        ...
        ([CONSTANT_450, CONSTANT_300], "Int64", "integer", "Int16"),
        ...
        ([CONSTANT_450, -CONSTANT_300], "Int64", "signed", "Int16"),
        ...
        ([CONSTANT_450, -CONSTANT_300], "Int64", "unsigned", "Int64"),
...
@pytest.mark.parametrize("val", [CONSTANT_9876543210.0, 2.0**CONSTANT_128])
