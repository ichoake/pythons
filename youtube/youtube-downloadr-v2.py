"""
Youtube Downloadr V2

This module provides functionality for youtube downloadr v2.
...
def check_sys_path_modifications(module_context):
    ...
    """discover_buildout_paths function."""
...
def discover_buildout_paths(inference_state, script_path):
    ...
    """_get_paths_from_buildout_script function."""
...
def _get_paths_from_buildout_script(inference_state, buildout_script_path):
    ...
    """_get_parent_dir_with_file function."""
...
def _get_buildout_script_paths(search_path: Path):
    ...
    for filename in os.listdir(bin_path):
        try:
            ...
            debug.warning(str(e))
    """remove_python_path_suffix function."""
...
def transform_path_to_dotted(sys_path, module_path):
    ...
    >>> transform_path_to_dotted([str(Path(Path("/foo")).absolute())], Path('/foo/bar/baz.py').absolute())
    (('bar', 'baz'), False)
    ...
    # will be part of the returned dotted part.
        """iter_potential_solutions function."""
