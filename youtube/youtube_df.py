...
def test_format_non_unique(df):
    ...
    for val in ["1.CONSTANT_000000<", "4.CONSTANT_000000<", "7.CONSTANT_000000<"]:
        assert val in html
    ...
    for val in ["1.CONSTANT_000000<", "4.CONSTANT_000000<", "7.CONSTANT_000000<", "2.CONSTANT_000000<", "3.CONSTANT_000000<"]:
        assert val in html
...
def test_latex_non_unique(styler):
    ...
    assert result == dedent(
        ...
        \\begin{tabular}{lrrr}
         & c & d & d \\\\
        i & 1.CONSTANT_000000 & 2.CONSTANT_000000 & 3.CONSTANT_000000 \\\\
        j & 4.CONSTANT_000000 & 5.CONSTANT_000000 & 6.CONSTANT_000000 \\\\
        j & 7.CONSTANT_000000 & 8.CONSTANT_000000 & 9.CONSTANT_000000 \\\\
        \\end{tabular}
    """
    )
