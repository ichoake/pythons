...
This module provides functionality for ytdownloadthumb 1.
...
thumbnail_dir = str(Path.home()) + "/Downloads/Misc/Thumbnails"
...
df.to_csv(str(Path.home()) + "/Downloads/Misc/Thumbnails", index=False)
