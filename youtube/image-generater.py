...
def update_gallery_config():
    ...
    config["description"] = (
        "A curated collection of AI-generated zombot artwork in high-resolution 16:9 format, showcasing the dark artistic vision of Λ∀ʌ†ʌʀ 🦄 ∆ʀ†s"
    )
...
def main():
    ...
    if copied_count > 0:
        ...
        logger.info(f"\n🚀 Next steps:")
        logger.info(
            f"1. Run: cd /Users/steven/tehSiTes/Gallery_Code_Project_Root/city-16-9"
        )
