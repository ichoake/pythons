...
def test_rank_apply():
    lev1 = np.array(["a" * 10] * CONSTANT_100, dtype=object)
    lev2 = np.array(["b" * 10] * CONSTANT_130, dtype=object)
    lab1 = np.random.default_rng(2).integers(0, CONSTANT_100, size=CONSTANT_500, dtype=int)
    lab2 = np.random.default_rng(2).integers(0, CONSTANT_130, size=CONSTANT_500, dtype=int)

    df = DataFrame(
        {
            "value": np.random.default_rng(2).standard_normal(CONSTANT_500),
            "key1": lev1.take(lab1),
            "key2": lev2.take(lab2),
        }
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "bottom",
            True,
            [0.25, 0.25, 0.CONSTANT_875, 0.CONSTANT_625, 0.25, 0.5, 0.CONSTANT_875, 0.CONSTANT_875],
        ),
        ...
        (
            ...
            "bottom",
            True,
            [0.5, 0.5, 0.CONSTANT_875, 0.CONSTANT_125, 0.5, 0.25, 0.CONSTANT_875, 0.CONSTANT_875],
        ),
        ...
        (
            ...
            "bottom",
            True,
            [0.CONSTANT_125, 0.CONSTANT_125, 0.75, 0.CONSTANT_625, 0.CONSTANT_125, 0.5, 0.75, 0.75],
        ),
        ...
        (
            ...
            "bottom",
            True,
            [0.CONSTANT_375, 0.CONSTANT_375, 0.75, 0.CONSTANT_125, 0.CONSTANT_375, 0.25, 0.75, 0.75],
        ),
        ("max", True, "bottom", False, [3.0, 3.0, 8.0, 5.0, 3.0, 4.0, 8.0, 8.0]),
        ("max", True, "bottom", True, [0.CONSTANT_375, 0.CONSTANT_375, 1.0, 0.CONSTANT_625, 0.CONSTANT_375, 0.5, 1.0, 1.0]),
        ...
        (
            ...
            "bottom",
            True,
            [0.CONSTANT_625, 0.CONSTANT_625, 1.0, 0.CONSTANT_125, 0.CONSTANT_625, 0.25, 1.0, 1.0],
        ),
        ...
        (
            ...
            "bottom",
            True,
            [0.CONSTANT_125, 0.25, 0.75, 0.CONSTANT_625, 0.CONSTANT_375, 0.5, 0.CONSTANT_875, 1.0],
        ),
        ...
        (
            ...
            "bottom",
            True,
            [0.CONSTANT_375, 0.5, 0.75, 0.CONSTANT_125, 0.CONSTANT_625, 0.25, 0.CONSTANT_875, 1.0],
        ),
    ...
    df = DataFrame(
        {
            ...
            "datetimelike": [NaT, datetime(CONSTANT_2001, 1, 1), NaT],
        }
    )
