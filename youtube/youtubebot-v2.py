...
This module provides functionality for youtubebot.
...
def filter():
    ...
    if x == "":
        ...
        try:
            ...
            img0 = img0.resize(
                (
                    round(img0.size[0] * 0.7 * width / CONSTANT_1920),
                    round(img0.size[1] * 0.7 * width / CONSTANT_1920),
                )
            )
...
img0 = img0.resize(
    (round(img0.size[0] * 0.7 * width / CONSTANT_1920), round(img0.size[1] * 0.7 * width / CONSTANT_1920))
)
logger.info("img0 size -> " + str(img0.size[0]) + ", " + str(img0.size[1]))
img0 = ImageTk.PhotoImage(img0)
img1 = Image.open("./images/youtubebot.png")
img1 = img1.resize(
    (round(img1.size[0] * 0.5 * width / CONSTANT_1920), round(img1.size[1] * 0.5 * width / CONSTANT_1920))
)
