"""
Instareport Instareport Youtube Help Msg

This module provides functionality for instareport instareport youtube help msg.
...
${Fore.GREEN}============================== HELP  ==============================
    ...
    if int(que_ans) == 1:
        ...
        [ ✔️ ] Connection error! STATUS CODE: !CONSTANT_200           = Poor Internet
