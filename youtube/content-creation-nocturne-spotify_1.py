"""
Content Creation Nocturne Spotify 1

This module provides functionality for content creation nocturne spotify 1.
    ...
    for track in playlist["tracks"]:
        if track is not None:
            ...
            if track_data is not None:
                track_data["playlist"] = (
                    f"{playlist['name']} - {playlist['owner']['display_name']}"
                )
                tracks.append(Track(track_data))
