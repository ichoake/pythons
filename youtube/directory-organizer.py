...
class DirectoryOrganizer:
    def __init__(self, target_dir: str):
        ...
        self.backup_patterns = [
            ...
            'automated_fixes_backup', 'merge_backup', 'merge_analysis'
        ]
        
        # Category mappings
        self.youtube_keywords = [
            'youtube', 'yt-', 'video-generator', 'automated-yt', 
            'auto-youtube', 'shorts', 'livestream'
        ]
        
        self.social_keywords = [
            'instagram', 'instapy', 'igbot', 'tiktok', 'reddit',
            'twitch', 'facebook', 'fb-script', 'telegram', 'tg-'
        ]
        
        self.ai_keywords = [
            'dalle', 'leonardo', 'gemini', 'llm', 'ai-', 'gpt',
            'comics_generator', 'manga', 'sora'
        ]
        
        self.web_scraping_keywords = [
            'scrape', 'scraper', 'backlink', 'seo-'
        ]
        
        self.media_keywords = [
            'upscale', 'photoshop', 'image', 'video', 'audio',
            'spotify', 'savify', 'remove-bg'
        ]
        
        self.utility_keywords = [
            'rsync', 'fdupes', 'folder-file', 'file-handling',
            'organizer', 'sort', 'clean'
        ]
    ...
    def categorize_folder(self, folder_name: str) -> str:
        ...
        # Check documentation
        if any(x in folder_lower for x in ['docs', 'documentation', 'comprehensive_docs']):
        ...
        # Check special cases
        if folder_name in ['scripts', '_versions', '-p_segments', 'github_improvements', 'github_templates']:
            return '01_CORE_TOOLS'
    ...
    def generate_report(self, plan, stats, dry_run):
        ...
        report_path = self.target_dir / f"DIRECTORY_ORGANIZATION_REPORT_{self.timestamp}.md"
