...
This module provides functionality for storykeytrans.
...
# Load environment variables, respecting the ~/.env.d setup
load_dotenv()
...
if not client.api_key:
    ...
    logger.info("Please ensure your environment is loaded correctly, e.g., by running 'source ~/.env.d/loader.sh'")
    exit(1)
