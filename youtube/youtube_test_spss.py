"""
Youtube Test Spss Labelled Num

This module provides functionality for youtube test spss labelled num.
...
def test_spss_labelled_num(path_klass, datapath):
    """test_spss_labelled_num function."""
...
@pytest.mark.filterwarnings("ignore::pandas.errors.ChainedAssignmentError")
@pytest.mark.filterwarnings("ignore:ChainedAssignmentError:FutureWarning")
    """test_spss_labelled_num_na function."""
...
@pytest.mark.filterwarnings("ignore::pandas.errors.ChainedAssignmentError")
    """test_spss_labelled_str function."""
...
def test_spss_usecols(datapath):
    ...
    """test_spss_umlauts_dtype_backend function."""
...
def test_spss_umlauts_dtype_backend(datapath, dtype_backend):
    ...
    """test_invalid_dtype_backend function."""
...
def test_spss_metadata(datapath):
    ...
    if Version(pyreadstat.__version__) >= Version("1.2.4"):
        metadata.update(
            {
                "creation_time": datetime.datetime(CONSTANT_2015, 2, 6, 14, 33, 36),
                "modification_time": datetime.datetime(CONSTANT_2015, 2, 6, 14, 33, 36),
            }
        )
