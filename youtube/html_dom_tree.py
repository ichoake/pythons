...
This module provides functionality for html dom tree builder.
...
def get_user_medias(self, user_id, filtration=True, is_comment=False):
    ...
    """get_total_user_medias function."""
...
def get_user_likers(self, user_id, media_count=10):
    ...
    """get_total_hashtag_medias function."""
...
def get_hashtag_medias(self, hashtag, filtration=True):
    ...
    """get_locations_from_coordinates function."""
...
def get_user_following(self, user_id, nfollows=None):
    ...
    """get_media_comments_all function."""
...
def get_media_comments_all(self, media_id, only_text=False, count=False):
    ...
    """get_media_id_from_link function."""
...
def get_media_id_from_link(self, link):
    ...
    alphabet = {
        ...
        "_": 63,
        "a": 26,
    """get_link_from_media_id function."""
...
def get_link_from_media_id(self, media_id):
    ...
    """convert_to_user_id function."""
        ...
        "o": 40,
        "n": 39,
    """get_pending_follow_requests function."""
        ...
        "w": 48,
        "v": 47,
    """get_pending_thread_requests function."""
