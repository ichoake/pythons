...
This module provides functionality for background.
...
def get_start_and_end_times(video_length, length_of_clip):
    """get_start_and_end_times function."""

    random_time = randrange(CONSTANT_180, int(length_of_clip) - int(video_length))
