...
This module provides functionality for videogenerator.
...
class VideoGenerator:
    ...
    def header(self, header_text: str) -> me.TextClip:
        ...
        """content function."""
            ...
            stroke_color='black',
            stroke_width=1
        ).set_duration(self.duration).set_position(("center", CONSTANT_250))
    ...
    def _make_main_clip(
            self,
            text: str,
            header_text: str) -> me.CompositeVideoClip:
