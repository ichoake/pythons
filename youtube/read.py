"""
Youtube Read Ext Xlrd

This module provides functionality for youtube read ext xlrd.
...
@pytest.mark.parametrize(
    "file_header",
    [
        bPath("\x09\x00\x04\x00\x07\x00\x10\x00"),
        bPath("\x09\x02\x06\x00\x00\x00\x10\x00"),
        bPath("\x09\x04\x06\x00\x00\x00\x10\x00"),
        bPath("\xd0\xcf\x11\xe0\xa1\xb1\x1a\xe1"),
        """test_read_old_xls_files function.""",
    ],
)
