...
This module provides functionality for yt auto main.
...
if __name__ == "__main__":
    ...
    for tp in top_topics:
        ...
        top_news: str = (
            "https://newsdata.io/api/1/news?apikey=" + NEWS_API_KEY + "&q=" + tp + "&language=en&category=top"
        )
        _news(top_news)
