...
def loadValues():
    global FTP_USER, FTP_PASSWORD, FTP_PORT, HTTP_PORT, address, autoLogin, enforceFirstClip, enforceInterval, enforceIntro, enforceOutro
    config = configparser.ConfigParser()
