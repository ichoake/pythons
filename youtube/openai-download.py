...
class AdvancedContentAnalyzer:
    ...
    def _multimedia_analysis(self, text: str, context: str = "") -> str:
        ...
        response = self.client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": f"Analyze this multimedia content: {text}\n\nContext: {context}"},
            ],
    ...
    def _shorts_analysis(self, text: str, context: str = "") -> str:
        ...
        response = self.client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": f"Analyze this YouTube Shorts content: {text}\n\nContext: {context}"},
            ],
    ...
    def batch_analyze(
        self, files: List[Path], mode: str = "detailed", output_dir: Optional[Path] = None
    ) -> Dict[Path, str]:
