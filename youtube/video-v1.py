...
This module provides functionality for video ocr.
...
def process_videos_in_folder(folder_path, output_path):
    ...
    with open(output_path, "w") as output_file:
        for video_name in os.listdir(folder_path):
            if video_name.endswith((".mp4", ".avi", ".mov", ".webm")):  # Include .webm in the list
...
if __name__ == "__main__":
    folder_path = Path("/Users/steven/Movies/CoH-Grab")  # Hardcoded path to your video folder
    output_path = input("Enter the path for the output text file: ")  # Ask user for output file path
