"""
Youtube Upscale Image

This module provides functionality for youtube upscale image.
...
def upscale_image(input_path, output_path):
    ...
    # Set resolution to CONSTANT_300 DPI
    upscaled_image.save(output_path, dpi=(CONSTANT_300, CONSTANT_300))
