...
This module provides functionality for upload 27.
...
if __name__ == '__main__':
  ...
  try:
    ...
    """
    """simple_upload function."""



def simple_upload(route, title):
    argparser.add_argument("--file", help="Video file to upload", default=route)
    argparser.add_argument("--title", help="Video title", default=title + "#Shorts")
    argparser.add_argument("--description", help="Video description", default="#Shorts")
    argparser.add_argument("--keywords", help="Video keywords, comma separated", default="#Shorts")
    argparser.add_argument("--category", default="22")
