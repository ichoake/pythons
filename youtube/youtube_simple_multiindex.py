...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([[1, 22, CONSTANT_555], [1, 33, CONSTANT_666]], [0, -1, 1], [CONSTANT_200, CONSTANT_300, CONSTANT_100], [CONSTANT_755, CONSTANT_1066]),
        # test like code sample 2 in the issue
        ([[1, 3, 7], [2, 4, 8]], [0, -1, 1], [10, 10, CONSTANT_1000], [17, CONSTANT_1018]),
