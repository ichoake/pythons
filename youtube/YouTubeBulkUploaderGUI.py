...
This module provides functionality for youtubebulkuploadergui.
...
-Andrew <andrew@beveridge.uk>"""
        ...
        tk.Label(welcome_window, text=message, wraplength=CONSTANT_600, justify="left").pack(padx=20, pady=10)
