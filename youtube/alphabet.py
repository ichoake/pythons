...
This module provides functionality for alphabet.
...
def generate_grouped_gallery(folder_path, output_html, group_size=4):
    ...
    for group_index, group in enumerate(grouped_files):
        html_content += f'<div class="group"><h2>Group {group_index + 1}</h2><div class="gallery">'
...
# Example usage
folder_path = Path("/Users/steven/AvaTarArTs/FunnySkeletonLifeTarotCard/images/photos")  # Replace with your folder path
output_html = Path("/Users/steven/AvaTarArTs/FunnySkeletonLifeTarotCard/grouped_gallery.html")  # Output HTML path
