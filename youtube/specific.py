...
class SpecificFunctionalCategorizer:
    ...
    def __init__(self):
        ...
        self.specific_categories = {
            ...
            "transcribe-analysis": {
                "keywords": ["transcribe", "whisper", "speech", "stt", "speech_to_text", "mp3", "mp4", "audio_to_text"],
            ...
            "upscaler": {
                "keywords": ["upscale", "enhance", "resolution", "super_resolution", "enlarge", "upscaling"],
            ...
            "gallery-generator": {
                "keywords": ["gallery", "album", "portfolio", "photo_grid", "image_gallery", "html_gallery"],
            ...
            "youtube-downloader": {
                "keywords": ["youtube", "yt-dlp", "pytube", "download_video", "youtube_dl"],
            ...
            "instagram-bot": {
                "keywords": ["instagram", "instabot", "instapy", "ig_bot", "like", "follow", "unfollow"],
            ...
            "video-editor": {
                "keywords": ["edit_video", "ffmpeg", "moviepy", "video_edit", "cut", "trim"],
            ...
            "video-converter": {
                "keywords": ["convert_video", "mp4_to_avi", "transcode", "format_video"],
            ...
            "ai-image-generator": {
                "keywords": ["dalle", "stable_diffusion", "midjourney", "generate_image", "text_to_image"],
            ...
            "monitoring-dashboard": {
                "keywords": ["monitor", "dashboard", "metrics", "prometheus", "grafana"],
    ...
    def categorize_project(self, project_path: Path) -> Dict:
        ...
        return {
            ...
            "category_descriptions": {k: v["description"] for k, v in self.specific_categories.items()},
        }
