...
FTP_PORT = CONSTANT_2121
HTTP_PORT = CONSTANT_8000
...
videoGeneratorFTPPort = CONSTANT_2122
videoGeneratorHTTPPort = CONSTANT_8001
...
def loadValues():
    global FTP_PORT, HTTP_PORT, serveraddress, videoGeneratorAddress, videoGeneratorFTPPort, videoGeneratorHTTPPort, videoGeneratorFTPUser, videoGeneratorFTPPassword, language, databasehost, databasepassword, databaseuser, s_v_web_id, tt_webid
    config = configparser.RawConfigParser()
