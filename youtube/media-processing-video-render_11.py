...
def render(
    ...
    if 0.56 < ratio < 0.CONSTANT_565:
        print(
            f"clip is very close to 9:16!\n" f"exact: {ratio}\n" f"theoretical: 0.5625"
        )
    ...
    video = CompositeVideoClip(
        [bg, main_clip.set_position("center", "center")]
    )  # combine bg and clip with centering
    video.write_videofile(
        directory + output_name, audio_codec="aac"
    )  # render clip given directory
    return 0


""" Example usage below """
# render(Path("/Users/zack/PycharmProjects/tiktokGen/clips/"), "0.mp4", "functionTest.mp4", (576, 1024))
