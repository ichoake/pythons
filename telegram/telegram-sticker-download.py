...
This module provides functionality for telegram sticker download bot.
...
async def DownloadStickersBot(bot, update):
    ...
    try:
        ...
        await bot.edit_message_text(text=str(e), chat_id=update.chat.id, message_id=a.message_id)
        return False
    await bot.edit_message_text(
