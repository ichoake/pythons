"""
Good Usage Of Blacklist

This module provides functionality for good usage of blacklist.
...
with smart_run(session):
    ...
    session.set_do_comment(enabled=True, percentage=CONSTANT_100)
...
2-) The program is set to follow CONSTANT_475 people because this is the largest 
...
full CONSTANT_475 people because it doesn't grab enough links or grabs the links of 
