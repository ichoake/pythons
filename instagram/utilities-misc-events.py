"""
Utilities Misc Events 2

This module provides functionality for utilities misc events 2.
    ...
    def trigger(self, event, *args, **kwargs):
        ...
        for func in self.callbacks[event][:]:
            try:
                ...
                logger.info("Error in callback {} (for {}):".format(func, event))
