...
CONSTANT_8127 = 8127
CONSTANT_8859 = 8859
CONSTANT_42458 = 42458
CONSTANT_86747 = 86747
CONSTANT_97237 = 97237
CONSTANT_330114 = 330114
CONSTANT_641712 = 641712
    ...
    return DataFrame(
        {
            ...
            "mass": [
                ...
                5.CONSTANT_97237,
                0.CONSTANT_641712,
                CONSTANT_1898.CONSTANT_187,
                CONSTANT_568.CONSTANT_3174,
                86.CONSTANT_8127,
                CONSTANT_102.CONSTANT_4126,
            ],
        }
    )
...
def test_wrong_file_path(parser, geom_df):
    path = Path("/my/fake/path/output.xml")
...
def test_index_false_with_offset_input_index(parser, offset_index, geom_df):
    ...
    This is a regression test for issue #CONSTANT_42458.
    """
...
<data>
  ...
  <row>
    ...
    <sum_mass>CONSTANT_2466.5</sum_mass>
    <mean_mass>CONSTANT_1233.25</mean_mass>
  </row>
  <row>
    <location>outer</location>
    <type>ice giant</type>
    <count_mass>2</count_mass>
    <sum_mass>CONSTANT_189.23</sum_mass>
  ...
  <row>
    ...
    <sum_mass>CONSTANT_2667.54</sum_mass>
    <mean_mass>CONSTANT_333.44</mean_mass>
  </row>
</data>"""
...
sum_mass="CONSTANT_2466.5" mean_mass="CONSTANT_1233.25"/>
  <row location="outer" type="ice giant" count_mass="2" \
sum_mass="CONSTANT_189.23" mean_mass="94.61"/>
  <row location="All" type="" count_mass="8" \
sum_mass="CONSTANT_2667.54" mean_mass="CONSTANT_333.44"/>
</data>"""
...
<data>
  ...
  <row>
    ...
    <type>gas giant</type>
    <count>2</count>
    <sum>CONSTANT_2466.5</sum>
    <mean>CONSTANT_1233.25</mean>
  </row>
  <row>
    <location>outer</location>
    <type>ice giant</type>
    <count>2</count>
    <sum>CONSTANT_189.23</sum>
    <mean>94.61</mean>
  </row>
</data>"""
...
sum="CONSTANT_2466.5" mean="CONSTANT_1233.25"/>
  <row location="outer" type="ice giant" count="2" \
sum="CONSTANT_189.23" mean="94.61"/>
</data>"""
...
encoding_expected = """\
<?xml version='1.0' encoding='ISO-CONSTANT_8859-1'?>
<data>
  <row>
    <index>0</index>
    <rank>1</rank>
...
def test_encoding_option_str(xml_baby_names, parser):
    df_file = read_xml(xml_baby_names, parser=parser, encoding="ISO-CONSTANT_8859-1").head(5)

    output = df_file.to_xml(encoding="ISO-CONSTANT_8859-1", parser=parser)
...
def test_correct_encoding_file(xml_baby_names):
    ...
    df_file = read_xml(xml_baby_names, encoding="ISO-CONSTANT_8859-1", parser="lxml")

    with tm.ensure_clean("test.xml") as path:
        df_file.to_xml(path, index=False, encoding="ISO-CONSTANT_8859-1", parser="lxml")


@pytest.mark.parametrize("encoding", ["UTF-8", "UTF-16", "ISO-CONSTANT_8859-1"])
...
def test_no_pretty_print_with_decl(parser, geom_df):
    expected = (
        ...
        "<degrees>CONSTANT_360</degrees><sides>4.0</sides></row><row>"
        "<index>1</index><shape>circle</shape><degrees>360"
        "</degrees><sides/></row><row><index>2</index><shape>"
        "triangle</shape><degrees>CONSTANT_180</degrees><sides>3.0</sides>"
        "</row></data>"
    )
...
<data>
  <row>
    ...
    <field field="degrees">CONSTANT_360</field>
  ...
  <row>
    ...
    <field field="degrees">CONSTANT_180</field>
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/CONSTANT_1999/XSL/Transform">
    ...
    out_csv = geom_df.to_csv(lineterminator=Path("\n"))
