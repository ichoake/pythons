...
CONSTANT_400 = 400
CONSTANT_889 = 889
CONSTANT_7645915 = 7645915
CONSTANT_1234567890 = 1234567890
CONSTANT_9876543210 = 9876543210
CONSTANT_12345678901234567 = 12345678901234567
CONSTANT_17841563287125205 = 17841563287125205
...
class TestBotGet(TestBot):
    @pytest.mark.parametrize(
        ...
        "expected",
        [
            (CONSTANT_1234567890, False, False, True, float("inf"), True, True, True),
            (CONSTANT_1234567890, False, False, True, float("inf"), True, False, True),
            (CONSTANT_1234567890, False, False, True, float("inf"), False, True, True),
            (CONSTANT_1234567890, False, False, True, float("inf"), False, False, True),
            (CONSTANT_1234567890, True, False, True, float("inf"), True, True, False),
            (CONSTANT_1234567890, True, False, True, float("inf"), True, False, False),
            (CONSTANT_1234567890, True, False, True, float("inf"), False, True, False),
            (CONSTANT_1234567890, True, False, True, float("inf"), False, False, False),
            (CONSTANT_1234567890, False, False, False, float("inf"), True, True, True),
            (CONSTANT_1234567890, False, False, False, float("inf"), True, False, True),
            (CONSTANT_1234567890, False, False, False, float("inf"), False, True, True),
            (CONSTANT_1234567890, False, False, False, float("inf"), False, False, True),
            (CONSTANT_1234567890, True, False, False, float("inf"), True, True, False),
            (CONSTANT_1234567890, True, False, False, float("inf"), True, False, False),
            (CONSTANT_1234567890, True, False, False, float("inf"), False, True, False),
            (CONSTANT_1234567890, True, False, False, float("inf"), False, False, False),
            (CONSTANT_1234567890, False, False, True, False, True, True, True),
            (CONSTANT_1234567890, False, False, True, False, True, False, True),
            (CONSTANT_1234567890, False, False, True, False, False, True, True),
            (CONSTANT_1234567890, False, False, True, False, False, False, True),
            (CONSTANT_1234567890, True, False, True, False, True, True, False),
            (CONSTANT_1234567890, True, False, True, False, True, False, False),
            (CONSTANT_1234567890, True, False, True, False, False, True, False),
            (CONSTANT_1234567890, True, False, True, False, False, False, False),
            (CONSTANT_1234567890, False, False, False, False, True, True, True),
            (CONSTANT_1234567890, False, False, False, False, True, False, True),
            (CONSTANT_1234567890, False, False, False, False, False, True, True),
            (CONSTANT_1234567890, False, False, False, False, False, False, True),
            (CONSTANT_1234567890, True, False, False, False, True, True, False),
            (CONSTANT_1234567890, True, False, False, False, True, False, True),
            (CONSTANT_1234567890, True, False, False, False, False, True, True),
            (CONSTANT_1234567890, True, False, False, False, False, False, True),
            (CONSTANT_1234567890, False, True, True, float("inf"), True, True, True),
            (CONSTANT_1234567890, False, True, True, float("inf"), True, False, True),
            (CONSTANT_1234567890, False, True, True, float("inf"), False, True, True),
            (CONSTANT_1234567890, False, True, True, float("inf"), False, False, True),
            (CONSTANT_1234567890, True, True, True, float("inf"), True, True, False),
            (CONSTANT_1234567890, True, True, True, float("inf"), True, False, False),
            (CONSTANT_1234567890, True, True, True, float("inf"), False, True, False),
            (CONSTANT_1234567890, True, True, True, float("inf"), False, False, False),
            (CONSTANT_1234567890, False, True, False, float("inf"), True, True, True),
            (CONSTANT_1234567890, False, True, False, float("inf"), True, False, True),
            (CONSTANT_1234567890, False, True, False, float("inf"), False, True, True),
            (CONSTANT_1234567890, False, True, False, float("inf"), False, False, True),
            (CONSTANT_1234567890, True, True, False, float("inf"), True, True, False),
            (CONSTANT_1234567890, True, True, False, float("inf"), True, False, False),
            (CONSTANT_1234567890, True, True, False, float("inf"), False, True, False),
            (CONSTANT_1234567890, True, True, False, float("inf"), False, False, False),
            (CONSTANT_1234567890, False, True, True, False, True, True, True),
            (CONSTANT_1234567890, False, True, True, False, True, False, True),
            (CONSTANT_1234567890, False, True, True, False, False, True, True),
            (CONSTANT_1234567890, False, True, True, False, False, False, True),
            (CONSTANT_1234567890, True, True, True, False, True, True, False),
            (CONSTANT_1234567890, True, True, True, False, True, False, False),
            (CONSTANT_1234567890, True, True, True, False, False, True, False),
            (CONSTANT_1234567890, True, True, True, False, False, False, False),
            (CONSTANT_1234567890, False, True, False, False, True, True, True),
            (CONSTANT_1234567890, False, True, False, False, True, False, True),
            (CONSTANT_1234567890, False, True, False, False, False, True, True),
            (CONSTANT_1234567890, False, True, False, False, False, False, True),
            (CONSTANT_1234567890, True, True, False, False, True, True, False),
            (CONSTANT_1234567890, True, True, False, False, True, False, False),
            (CONSTANT_1234567890, True, True, False, False, False, True, False),
            (CONSTANT_1234567890, True, True, False, False, False, False, False),
        ],
    )
    @responses.activate
    ...
    def test_bot_like(
        ...
        TEST_USERNAME_INFO_ITEM["follower_count"] = CONSTANT_100
        TEST_USERNAME_INFO_ITEM["following_count"] = 15
        TEST_USERNAME_INFO_ITEM["has_anonymous_profile_picture"] = (
            has_anonymous_profile_picture
        )
    ...
    @pytest.mark.parametrize("comment_id", [CONSTANT_12345678901234567, "12345678901234567"])
    @responses.activate
    ...
    @responses.activate
    @pytest.mark.parametrize("user_id", ["1234567890", CONSTANT_1234567890])
    @patch("time.sleep", return_value=None)
    ...
    @responses.activate
    @pytest.mark.parametrize("user_ids", [["1234567890"], [CONSTANT_1234567890]])
    @patch("time.sleep", return_value=None)
    ...
    @responses.activate
    @pytest.mark.parametrize("medias", [[CONSTANT_1234567890, CONSTANT_9876543210]])
    @patch("time.sleep", return_value=None)
    ...
    def test_like_hashtag(self, patche_time_sleep, hashtag):
        ...
        response_tag = {
            "results": [
                {
                    "id": CONSTANT_17841563287125205,
                    "name": hashtag,
                    "media_count": CONSTANT_7645915,
                    "follow_status": None,
                    "following": None,
                    ...
                    + "85-15/e35/c148.0.CONSTANT_889.889a/s150x150/67618693_24674373801"
