...
# Constants
CONSTANT_2000 = 2000
CONSTANT_1370745748 = 1370745748
...
def test_index_unique(rand_series_with_duplicate_datetimeindex):
    ...
    expected = DatetimeIndex(
        [
            datetime(CONSTANT_2000, 1, 2),
            datetime(CONSTANT_2000, 1, 3),
            datetime(CONSTANT_2000, 1, 4),
            datetime(CONSTANT_2000, 1, 5),
        ],
        dtype=index.dtype,
    )
...
def test_index_unique2():
    ...
    arr = [CONSTANT_1370745748 + t for t in range(20)] + [NaT._value]
