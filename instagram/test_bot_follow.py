...
class TestBotFilter(TestBot):
    ...
    def test_follow(self, patched_time_sleep, username):
        ...
        my_test_search_username_item["follower_count"] = CONSTANT_100
        ...
        my_test_username_info_item["follower_count"] = CONSTANT_100
    ...
    def test_follow_followers(self, patched_time_sleep, username):
        ...
        for i, _ in enumerate(range(results_3)):
            ...
            my_test_search_username_items[i]["follower_count"] = CONSTANT_100
            ...
            my_test_username_info_items[i]["follower_count"] = CONSTANT_100
