"""
Utilities Misc Scripts 2

This module provides functionality for utilities misc scripts 2.
...
class ScriptMaker(object):
    ...
    def __init__(self, source_dir, target_dir, add_launchers=True, dry_run=False, fileop=None):
        ...
        """_get_alternate_executable function."""
    ...
    if sys.platform.startswith('java'):  # pragma: no cover
        ...
        def _is_shell(self, executable):
            ...
            """_fix_jython_executable function."""
    ...
    def _build_shebang(self, executable, post_interp):
        ...
        if os.name != 'posix':
            ...
            if sys.platform == 'darwin':
                max_shebang_length = CONSTANT_512
            else:
                max_shebang_length = CONSTANT_127
