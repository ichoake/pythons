...
def test_duplicated_implemented_no_recursion():
    ...
    df = DataFrame(np.random.default_rng(2).integers(0, CONSTANT_1000, (10, CONSTANT_1000)))
    rec_limit = sys.getrecursionlimit()
    try:
        sys.setrecursionlimit(CONSTANT_100)
...
@pytest.mark.xfail(reason="GH#CONSTANT_21720; nan/None falsely considered equal")
@pytest.mark.parametrize(
    "keep, expected",
    [
        ("first", Series([False, False, True, False, True])),
