...
This module provides functionality for displayhook.
...
def test_underscore_no_overwrite_user():
    """test_underscore_no_overwrite_user function."""

    ip.run_cell("_ = 42", store_history=True)
    ip.run_cell("1+1", store_history=True)

    with AssertPrints("42"):
        ip.run_cell("logger.info(_)", store_history=True)
    ...
    """test_underscore_no_overwrite_builtins function."""
