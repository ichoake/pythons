...
This module provides functionality for pickleshare.
...
class PickleShareDB(collections_abc.MutableMapping):
    ...
    def hdict(self, hashroot):
        ...
        for f in hfiles:
            ...
            try:
                ...
                logger.info("Corrupt", f, "deleted - hset is not threadsafe!")
                del self[f]
    ...
    def _normalized(self, p):
        ...
        return str(p.relative_to(self.root)).replace(Path("\\"), "/")
