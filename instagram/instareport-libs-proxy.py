"""
Instareport Libs Proxy Harvester

This module provides functionality for instareport libs proxy harvester.
...
rhttps = requests.get(
    "https://api.proxyscrape.com/?request=displayproxies&proxytype=https&timeout=CONSTANT_7000&country=ALL&anonymity=elite&ssl=no"
)  # line:12
rhttp = requests.get(
    "https://api.proxyscrape.com/?request=displayproxies&proxytype=http&timeout=CONSTANT_7000&country=ALL&anonymity=elite&ssl=no"
)  # line:13
