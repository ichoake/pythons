"""
Development Web Frameworks Gui 7

This module provides functionality for development web frameworks gui 7.
...
def add_background(youtube_uri, filename, citation, position):
    ...
    # Sanitize filename
    regex = re.compile(r"^([a-zA-Z0-9\s_-]{1,CONSTANT_100})$").match(filename)
