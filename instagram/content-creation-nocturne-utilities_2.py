...
from .bot_direct import (approve_pending_thread_requests, send_hashtag,
                         send_like, send_media, send_medias, send_message,
                         send_messages, send_photo, send_profile)
from .bot_filter import check_media, check_not_bot, check_user, filter_medias
from .bot_follow import (approve_pending_follow_requests, follow,
                         follow_followers, follow_following, follow_users,
...
from .bot_get import (convert_to_user_id, get_archived_medias, get_comment,
                      ...
                      get_last_user_medias, get_link_from_media_id,
                      get_locations_from_coordinates, get_media_commenters,
                      get_media_comments, get_media_comments_all,
                      get_media_id_from_link, get_media_info, get_media_likers,
                      get_media_owner, get_messages, get_muted_friends,
                      get_pending_follow_requests, get_pending_thread_requests,
                      get_popular_medias, get_self_story_viewers,
                      ...
                      get_user_likers, get_user_medias, get_user_reel,
                      get_user_stories, get_user_tags_medias,
...
from .bot_like import (like, like_comment, like_followers, like_following,
                       like_geotag, like_hashtag, like_location_feed,
                       like_media_comments, like_medias, like_timeline,
                       like_user, like_users)
from .bot_photo import (download_photo, download_photos, upload_album,
                        upload_photo)
...
class Bot(object):
    def __init__(
        self,
        base_path=current_path + Path("/config/"),
        ...
        proxy=None,
        max_likes_per_day=random.randint(50, CONSTANT_100),
        max_unlikes_per_day=random.randint(50, CONSTANT_100),
        max_follows_per_day=random.randint(50, CONSTANT_100),
        max_unfollows_per_day=random.randint(50, CONSTANT_100),
        max_comments_per_day=random.randint(50, CONSTANT_100),
        max_blocks_per_day=random.randint(50, CONSTANT_100),
        max_unblocks_per_day=random.randint(50, CONSTANT_100),
        max_likes_to_like=random.randint(50, CONSTANT_100),
        min_likes_to_like=random.randint(50, CONSTANT_100),
        max_messages_per_day=random.randint(50, CONSTANT_100),
        filter_users=False,
        ...
        max_followers_to_follow=CONSTANT_5000,
        min_followers_to_follow=10,
        max_following_to_follow=CONSTANT_2000,
        min_following_to_follow=10,
        max_followers_to_following_ratio=15,
        max_following_to_followers_ratio=15,
        min_media_count_to_follow=3,
        max_following_to_block=CONSTANT_2000,
        like_delay=random.randint(CONSTANT_300, CONSTANT_600),
        unlike_delay=random.randint(CONSTANT_300, CONSTANT_600),
        follow_delay=random.randint(CONSTANT_300, CONSTANT_600),
        unfollow_delay=random.randint(CONSTANT_300, CONSTANT_600),
        comment_delay=random.randint(CONSTANT_300, CONSTANT_600),
        block_delay=random.randint(CONSTANT_300, CONSTANT_600),
        unblock_delay=random.randint(CONSTANT_300, CONSTANT_600),
        message_delay=random.randint(CONSTANT_300, CONSTANT_600),
        stop_words=("shop", "store", "free"),
        blacklist_hashtags=["#shop", "#store", "#free"],
        blocked_actions_protection=True,
        blocked_actions_sleep=True,
        blocked_actions_sleep_delay=random.randint(CONSTANT_600, CONSTANT_1200),
        verbosity=True,
        device=None,
        save_logfile=True,
        log_filename=None,
    ...
    def following(self):
        ...
        if self._following is None or (now - last) > CONSTANT_7200:
    ...
    def followers(self):
        ...
        if self._followers is None or (now - last) > CONSTANT_7200:
    ...
    def very_small_delay(self):
        time.sleep(random.uniform(0.CONSTANT_175, 0.CONSTANT_875))
    ...
    def get_total_hashtag_medias(self, hashtag, amount=CONSTANT_100, filtration=False):
    ...
    def watch_users_reels(self, user_ids, max_users=CONSTANT_100):
