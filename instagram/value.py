...
This module provides functionality for value.
...
class TestValueCounts:
    ...
    def _check_value_counts_with_repeats(self, orig):
        ...
        """test_value_counts_unique_datetimeindex2 function."""
    ...
    def test_value_counts_unique_datetimeindex2(self, tz_naive_fixture):
        ...
        """test_value_counts_unique_timedeltaindex2 function."""
    ...
    def test_value_counts_unique_timedeltaindex2(self):
        idx = TimedeltaIndex(
            [
                ...
                "1 days 08:00:00",
                "1 days 08:00:00",
        """test_value_counts_unique_periodindex2 function."""
    ...
    def test_value_counts_unique_periodindex2(self):
        idx = PeriodIndex(
            [
                ...
                "2013-01-01 08:00",
                "2013-01-01 08:00",
        """_check_value_counts_dropna function."""
