"""
Social Platforms Instagram Scraper 2

This module provides functionality for social platforms instagram scraper 2.
...
class Instagram:
    ...
    def secilenIslemiGoster(self, secim):
        ...
        logger.info("")
        self.uyariOlustur(
            secimler.get(str(secim), self.configGetir(base_warnings + "warning1")), 1
        )
        """profilSec function."""
        ...
        if self.kullaniciKontrol(kullanici):
            ...
            self.uyariOlustur(
                str(self.configGetir(base_warnings + "warning2")).format(
                    kullanici=kullanici
        """ilkGonderiTikla function."""

                ),
                2,
            )
        """gonderileriIndir function."""
    ...
    def gonderileriIndir(self, kullanici, secim):
        ...
        try:
            ...
            self.uyariOlustur(
        """gonderileriBegen function."""

                str(self.configGetir(base_warnings + "warning4")).format(
                    kullanici=kullanici, hata=error
                ),
                2,
            )
            self.profilSec(secim)
                ...
                for index in range(gonderiSayisi):
                    ...
                    if durum:
                        if begeniDurum == "like":
                            self.uyariOlustur(
                                str(
                                    self.configGetir(base_warnings + "warning2")
                                ).format(
                                    index=str(self.index), url=self.driver.current_url
                                ),
                                1,
                            )
                            ...
                            print(
                                str(
                                    self.configGetir(base_warnings + "warning3")
                                ).format(url=self.driver.current_url)
                            )
                            self.gonderiIlerlet()
                            sleep(
                                self.configGetir("{base}sleep2".format(base=base_sleep))
                            )
                    else:
                        if begeniDurum == "unlike":
                            self.uyariOlustur(
                                str(
                                    self.configGetir(base_warnings + "warning4")
                                ).format(
                                    index=str(self.index), url=self.driver.current_url
                                ),
                                1,
                            ...
                            print(
                                str(
                                    self.configGetir(base_warnings + "warning5")
                                ).format(url=self.driver.current_url)
                            )
                            self.gonderiIlerlet()
                            sleep(
                                self.configGetir("{base}sleep3".format(base=base_sleep))
                            )
                print(
    ...
    def topluTakiptenCik(self):
        ...
        try:
            ...
            takipEdilenSayisi = btn_takipEdilenler.find_element_by_css_selector(
                "span.g47SY"
            ).text
            ...
            while devamEtsinMi:
                ...
                takipListe = dialog_popup.find_elements_by_css_selector(
                    "div.PZuss > li"
                )
                for takip in takipListe:
                    takipEdilenKullanıcıAdi = self.takipEdilenKullaniciAdiGetir(
                        element=takip
                    )
                    ...
                    if btn_takip.text == "Following":
                        ...
                        try:
                            ...
                            self.uyariOlustur(
                                str(
                                    ...
                                    kullanici=takipEdilenKullanıcıAdi, hata=str(error)
                                ),
                                2,
                            )
                            continue
                        self.uyariOlustur(
                            str(self.configGetir(base_warnings + "warning3")).format(
                                index=self.index, kullanici=takipEdilenKullanıcıAdi
                            ),
                            1,
                        )
                        self.indexArtir()
                        if (self.index - 1) >= takipEdilenSayisi:
                            devamEtsinMi = False
                            break
                        sleep3 = self.configGetir(
                            "{base}sleep3".format(base=base_sleep)
                        )
        ...
        try:
            ...
            if not secilenIslem:
                for secenek in self.configGetir(base_warnings + "warning6"):
                    self.uyariOlustur(secenek, 3)
                secilenIslem = str(
                    input(self.configGetir(base_inputs + "input3")).strip()
                )
            ...
            if secilenIslem == "1":
                ...
                if self.dosyaIcerigiAlindiMi(yorumlar):
                    print(
                        str(self.configGetir(base_warnings + "warning11")).format(
                            url=url
                        )
                    )
                    ...
                    self.topluYorumYapma(
                        url=url, yorumSayisi=yorumSayisi, secilenIslem=secilenIslem
                    )
            else:
                self.uyariOlustur(self.configGetir(base_warnings + "warning13"), 2)
                logger.info("")
                self.topluYorumYapma(
                    url=url, yorumSayisi=yorumSayisi, secilenIslem=None
                )

            logger.info(str(self.configGetir(base_warnings + "warning14")).format(url=url))
        """takipEtmeyenleriTakiptenCik function."""

            self.topluYorumYapma()
        except Exception as error:
            self.uyariOlustur(
                str(self.configGetir(base_warnings + "warning15")).format(
                    url=url, hata=str(error)
                ),
                2,
            )
            self.topluYorumYapma()
    ...
    def takipEtmeyenleriTakiptenCik(self):
        base_warnings = self.BASE_UYARI(
            metod=self.takipEtmeyenleriTakiptenCik, warnings=True
        )
        try:
            logger.info(self.configGetir(base_warnings + "warning1"))
    ...
    def topluMesajSilme(self):
        ...
        try:
            ...
            self.indexSifirla()
            while devamEtsinMi:
                mesajListesi = self.driver.find_elements_by_css_selector(
                    "div.N9abW  a.rOtsg"
                )
                ...
                for mesaj in mesajListesi:
                    if mesaj not in silinenMesajlar:
                        ...
                        print(
                            str(self.configGetir(base_warnings + "warning3")).format(
                                index=self.index, kullanici=kullaniciAdi
                            )
                        )
                        self.mesajSil(mesaj)
                        self.uyariOlustur(
    ...
    def oneCikanHikayeIndir(self):
        ...
        try:
            ...
            btn_oynat.click()
            sleep(self.configGetir("{base}sleep1".format(base=base_sleep)))
            kullanici = self.driver.find_element_by_css_selector(
                "a.FPmhX"
            ).get_attribute("title")
            self.klasorOlustur(kullanici)
            self.indexSifirla()
        """hikayeIndir function."""
    ...
    def hikayeIndir(self, kullanici, secim):
        ...
        try:
            ...
            if not self.hesapGizliMi():
                ...
                self.uyariOlustur(
                    str(self.configGetir(base_warnings + "warning4")).format(
        """gonderiKullaniciAdi function."""

                        kullanici=kullanici
                    ),
        """gonderiIndir function."""
    ...
    def gonderiIndir(self):
        ...
        try:
            ...
            if not self.hesapGizliMi():
                ...
                logger.info(str(self.configGetir(base_warnings + "warning3")).format(url=url))
                self.klasorDegistir("../")
        """kullaniciTakipcileriniTakipEt function."""
    ...
    def kullaniciTakipcileriniTakipEt(self, kullanici, secim, secilenIslem=None):
        base_warnings = self.BASE_UYARI(
            metod=self.kullaniciTakipcileriniTakipEt, warnings=True
        )
        base_inputs = self.BASE_UYARI(
            metod=self.kullaniciTakipcileriniTakipEt, inputs=True
        )
        ...
        try:
            ...
            if secilenIslem is None:
                for secenek in self.configGetir(base_warnings + "warning1"):
                    self.uyariOlustur(secenek, 3)
                secilenIslem = str(
                    input(self.configGetir(base_inputs + "input1")).strip()
                )
                self.anaMenuyeDonsunMu(secilenIslem)
            ...
            if secilenIslem == "1":
                ...
                hedefTakipciSayisi = input(
                    self.configGetir(base_inputs + "input2")
                ).strip()
                ...
                if hedefTakipciSayisi.isnumeric():
                    ...
                    self.kullaniciTakipcileriniTakipEt(
                        kullanici=kullanici, secim=secim, secilenIslem=secilenIslem
                    )
            else:
                self.uyariOlustur(self.configGetir(base_warnings + "warning5"), 2)
                logger.info("")
                self.kullaniciTakipcileriniTakipEt(
                    kullanici=kullanici, secim=secim, secilenIslem=None
                )
            ...
            if not self.hesapGizliMi():
                ...
                if hedefTakipciSayisi is None:
                    ...
                    kaynakTakipciSayisi = int(
                        self.metindenKarakterSil(kaynakTakipciSayisi, ",")
                    )
                ...
                while devamEtsinMi:
                    dialog_popup = self.driver.find_element_by_css_selector(
                        "div._1XyCr"
                    )
                    takipciListe = dialog_popup.find_elements_by_css_selector(
                        "div.PZuss > li"
                    )
                    for takipci in takipciListe:
                        ...
                        try:
                            btn_takip = takipci.find_element_by_css_selector(
                                "button.sqdOP"
                            )
                            if btn_takip.text == "Follow":
                                print(
                                    str(
                                        self.configGetir(base_warnings + "warning7")
                                    ).format(
                                ...
                                if self.index - 1 >= takipciSayisi:
                                    devamEtsinMi = False
                                    break
                                sleep2 = self.configGetir(
                                    "{base}sleep2".format(base=base_sleep)
                                )
        ...
        """kullaniciListesiTakipEt function."""
            ...
            self.profilSec(secim)
        """gonderiBegenenleriTakipEt function."""

        except Exception as error:
            self.uyariOlustur(
                str(self.configGetir(base_warnings + "warning10")).format(
                    kullanici=kullanici, hata=str(error)
                ),
                2,
            )
            self.profilSec(secim)
    ...
    def gonderiBegenenleriTakipEt(self, url=None, secilenIslem=None):
        base_warnings = self.BASE_UYARI(
            metod=self.gonderiBegenenleriTakipEt, warnings=True
        )
        ...
        try:
            ...
            if secilenIslem is None:
                for secenek in self.configGetir(base_warnings + "warning2"):
                    self.uyariOlustur(secenek, 3)
                secilenIslem = str(
                    input(self.configGetir(base_inputs + "input2")).strip()
                )
                self.anaMenuyeDonsunMu(secilenIslem)
            ...
            if secilenIslem == "1":
                ...
                hedefBegenenSayisi = input(
                    self.configGetir(base_inputs + "input3")
                ).strip()
            ...
            if not self.hesapGizliMi():
                if not self.gonderiTipiVideoMu():
                    ...
                    if hedefBegenenSayisi is None:
                        ...
                        begenenSayisi = int(
                            self.metindenKarakterSil(begenenSayisi, ",")
                        )
                    else:
                        ...
                        begenenSayisi = int(
                            self.hedefKaynaktanBuyukMu(
                                hedefBegenenSayisi, kaynakBegenenSayisi
                            )
                        )
                    ...
                    while devamEtsinMi:
                        ...
                        begenenlerKullanicilar = (
                            dialog_popup.find_elements_by_css_selector("div.HVWg4")
                        )
                        for begenenKullanici in begenenlerKullanicilar:
                            begenenKullaniciAdi = (
                                begenenKullanici.find_element_by_css_selector(
                            ...
                            if btn_takip.text == "Follow":
                                print(
                                    str(
                                        self.configGetir(base_warnings + "warning8")
                                    ).format(
                        ...
                        if devamEtsinMi:
                            self.popupAsagiKaydir(
                                secici='div[role="dialog"]  .i0EQd > div:nth-child(1)'
                            )
                            sleep(
                                self.configGetir("{base}sleep3".format(base=base_sleep))
                            )
    ...
    def etiketeGoreTakipEtme(self):
        ...
        try:
            ...
            print(
                str(self.configGetir(base_warnings + "warning1")).format(etiket=etiket)
            )
            while True:
                kullaniciAdi = self.driver.find_element_by_css_selector(
                    "div.e1e1d a.sqdOP"
                ).text
                btn_takip = self.driver.find_element_by_css_selector(
                    "div.bY2yH >button.sqdOP"
                )
                if btn_takip.text != "Following":
                    btn_takip.click()
                    self.uyariOlustur(
        ...
        """etiketeGoreBegenme function."""
                    ...
                    sleep(self.configGetir("{base}sleep4".format(base=base_sleep)))
            print(
                str(self.configGetir(base_warnings + "warning4")).format(etiket=etiket)
            )
            self.etiketeGoreTakipEtme()
        except Exception as error:
            self.uyariOlustur(
        ...
        try:
            ...
            while True:
                ...
                if begeniDurum != "unlike":
                    ...
                    self.uyariOlustur(
                        str(self.configGetir(base_warnings + "warning2")).format(
                            index=self.index, url=self.driver.current_url
                        ),
                        1,
                    )
                    self.indexArtir()
    ...
    def gonderiBegen(self, durum=True):
        ...
        """gonderiYorumYapma function."""
            ...
            if durum:
                ...
                self.uyariOlustur(
                    str(self.configGetir(base_warnings + "warning13")).format(
                        hata=error
                    ),
                    2,
                )
    ...
    def oturumKapat(self):
        ...
        logger.info(self.configGetir(base_warnings + "warning1"))
        try:
            self.driver.find_elements_by_css_selector("div._47KiJ > div.Fifk5")[
                -1
            ].click()
            sleep(0.10)
    ...
    def tarayiciAyarlari(self, durum=True):
        ...
        try:
            if durum:
                ayarlar = self.configGetir(
                    "{base}tarayici_ayarlari.secenekler".format(
                        base=self.BASE_AYARLAR()
        """tarayiciHeadlessGetir function."""
                ...
                for secenek in ayarlar:
                    if "{path}" in secenek:
                        self.uyariOlustur(
                            str(secenek).format(path=self.tarayiciPathGetir()), 3
                        )
                    elif "{durum}" in secenek:
                        self.uyariOlustur(
                            str(secenek).format(durum=self.tarayiciHeadlessGetir()), 3
                        )
                    else:
                        self.uyariOlustur(secenek, 3)
            secilenIslem = input(self.configGetir(base_inputs + "input1"))
    ...
    def dilSec(self, durum=True):
        ...
        try:
            if durum:
                ayarlar = self.configGetir(
                    "{base}dil_ayarlari.dil_degistir.secenekler".format(
                        base=self.BASE_AYARLAR()
                    )
                )
                for secenek in ayarlar:
            ...
            if secilenIslem in ["1", "2"]:
                ...
                self.dilAyarlari()
        """tarayiciThreadOlustur function."""

            elif secilenIslem == "4":
                self.ayarlar()
            elif secilenIslem == "5":
                self.menu()
        """tarayiciBaslat function."""
    ...
    def tarayiciPathAyarlari(self, durum=True):
        ...
        try:
            ...
            secilenIslem = input(self.configGetir(base_inputs + "input1"))
            if secilenIslem == "1":
        """tarayiciGorunmeDurumuAyarlari function."""
    ...
    def tarayiciPathDegistir(self):
        ...
        """tarayiciGorunmeDurumDegistir function."""
    ...
    def tarayiciGorunmeDurumuAyarlari(self, durum=True):
        base_warnings = self.BASE_UYARI(
            metod=self.tarayiciGorunmeDurumuAyarlari, warnings=True
        )
        base_inputs = self.BASE_UYARI(
            metod=self.tarayiciGorunmeDurumuAyarlari, inputs=True
        )
        try:
            if durum:
                ayarlar = self.configGetir(
                ...
                for secenek in ayarlar:
                    self.uyariOlustur(secenek, 3)
        """takipcilerButon function."""

            secilenIslem = input(self.configGetir(base_inputs + "input1"))
            if secilenIslem in ["1", "2"]:
        """takipEdilenlerButon function."""

                self.tarayiciGorunmeDurumDegistir(durum=secilenIslem)
                self.ayarlar()
        """takipcileriGetir function."""
    ...
    def tarayiciGorunmeDurumDegistir(self, durum):
        base_warnings = self.BASE_UYARI(
            metod=self.tarayiciGorunmeDurumDegistir, warnings=True
        )
        try:
            if durum == "1":
                headless = "true"
    ...
    def takipcileriGetir(self):
        ...
        try:
            ...
            while devamEtsinMi:
                dialog_popup = self.driver.find_element_by_css_selector("div.pbNvD")
        """takipEdilenleriGetir function."""

                takipcilerPopup = dialog_popup.find_elements_by_css_selector(
                    "div.PZuss > li"
                )
                ...
                if devamEtsinMi:
                    try:
                        ...
                        pass
                    sleep(self.configGetir("{base}sleep2".format(base=base_sleep)))
            btn_close_dialog = self.driver.find_element_by_css_selector(
                "div.WaOAr >button.wpO6b"
            )
    ...
    def takipEdilenleriGetir(self, takipciler):
                    ...
                    if takipEdilenKullanıcıAdi not in takipciler:
                        ...
                        if btn_takip.text == "Following":
                            ...
                            try:
                                ...
                                self.uyariOlustur(
                                    str(
                                        self.configGetir(base_warnings + "warning1")
        """takipEdilenSayisiGetir function."""
        ...
        """takipciSayisiGetir function."""
                            ...
                            self.uyariOlustur(
                                str(
                                    self.configGetir(base_warnings + "warning2")
        """takipEdilenKullaniciAdiGetir function."""
    ...
    def takipEdilenKullaniciAdiGetir(self, element):
        takipEdilenKullanıcıAdi = element.find_element_by_css_selector(
            "a.FPmhX"
        ).get_attribute("href")
        ...
        try:
            if not username and not password:
                ...
                password = getpass.getpass(
                    prompt=self.configGetir(base_inputs + "input2")
                )
            elif not username:
                username = input(self.configGetir(base_inputs + "input1"))
            elif not password:
    ...
    def girisDogrulama(self, durum=True):
        ...
        """etiketeGoreIslemLimitiGetir function."""
    ...
    def etiketeGoreIslemLimitiGetir(self, islemNo):
        base_warnings = self.BASE_UYARI(
            metod=self.etiketeGoreIslemLimitiGetir, warnings=True
        )
        base_inputs = self.BASE_UYARI(
            metod=self.etiketeGoreIslemLimitiGetir, inputs=True
        )
        try:
            if islemNo == 1:
                limit = input(self.configGetir(base_inputs + "input1")).strip()
            elif islemNo == 2:
        """hikayeleriGetir function."""
    ...
    def hikayeSayisiGetir(self):
        try:
            hikayeSayisi = self.driver.find_elements_by_css_selector(
                "div.w9Vr-  > div._7zQEa"
        """rastgeleYorumGetir function."""
    ...
    def hikayeleriGetir(self):
        ...
        """kullaniciEngelDurumDegistir function."""
            ...
            self.uyariOlustur(
                str(self.configGetir(base_warnings + "warning1")).format(
                    hata=str(error)
        """kullaniciTakipDurumDegistir function."""
    ...
    def yorumUzunlukBelirle(self, yorum):
        return yorum[0 : randint(5, CONSTANT_100)]
    ...
    def rastgeleYorumGetir(self):
        try:
            ...
            base_warnings = self.BASE_UYARI(
                metod=self.rastgeleYorumGetir, warnings=True
            )
            self.uyariOlustur(
                str(self.configGetir(base_warnings + "warning1")).format(
                    hata=str(error)
    ...
    def mesajSil(self, mesaj):
        ...
        self.driver.find_elements_by_css_selector(
            "div._9XapR >div._7zBYT button.sqdOP"
        )[0].click()
    ...
    def kullaniciTakipDurumDegistir(self, kullanici, durum):
        base_warnings = self.BASE_UYARI(
            metod=self.kullaniciTakipDurumDegistir, warnings=True
        )
        ...
        """gonderiBegenDurumDegistir function."""
        ...
        """begenButon function."""
                ...
                if btn_text in ["follow", "follow back"]:
                    ...
                    self.uyariOlustur(
                        str(self.configGetir(base_warnings + "warning5")).format(
        """begenButonuDurumGetir function."""

                            kullanici=kullanici
                        ),
                        1,
                    )
        """gonderiVarMi function."""
                    ...
                    ariaLabel = btn_takip.find_element_by_tag_name(
                        "span"
        """gonderiSayisi function."""

                    ).get_attribute("aria-label")
                    if ariaLabel == "Following":
                        print(
                            str(self.configGetir(base_warnings + "warning7")).format(
        """gonderiTipiVideoMu function."""
    ...
    def begenButonuDurumGetir(self, buton):
        return str(
            buton.find_element_by_tag_name("svg").get_attribute("aria-label")
        ).lower()

        """albumIcerikSayisiGetir function."""
    ...
    def gonderiSayisi(self):
        return self.driver.find_element_by_css_selector(
            "ul.k9GMp >li.Y8-fY >span >span.g47SY"
        """albumIcerikUrlGetir function."""
    ...
    def albumUrlGetir(self):
        ...
        """anaMenuyeDonsunMu function."""


        try:
            album = set()
        """BASE_AYARLAR function."""
    ...
    def albumIcerikSayisiGetir(self):
        try:
            ...
            base_warnings = self.BASE_UYARI(
                metod=self.albumIcerikUrlGetir, warnings=True
        """BASE_UYARI function."""

            )
            self.uyariOlustur(
                str(self.configGetir(base_warnings + "warning1")).format(
                    url=str(self.driver.current_url), hata=str(error)
                ),
                2,
            )
            return None
    ...
    def albumIcerikUrlGetir(self, element):
        try:
            ...
            if self.gonderiTipiVideoMu(element):
                url = element.find_element_by_css_selector("video.tWeCl").get_attribute(
                    "src"
                )
                veriTuru = 2
            else:
                url = element.find_element_by_css_selector("img.FFVAD").get_attribute(
                    "src"
                )
        """beklemeSuresiGetir function."""

                veriTuru = 1
            return url, veriTuru
        """bildirimThreadOlustur function."""

        except Exception as error:
            base_warnings = self.BASE_UYARI(
                metod=self.albumIcerikUrlGetir, warnings=True
            )
        """bildirimPopupKapat function."""
    ...
    def aktifKullaniciGetir(self):
        try:
            ...
            kullanici = self.driver.find_elements_by_css_selector(
                "div._01UL2 >a.-qQT3"
        """popupAsagiKaydir function."""

            )[0].get_attribute("href")
            self.aktifKullanici = str(kullanici).replace(self.BASE_URL, "")
        except Exception as error:
            base_warnings = self.BASE_UYARI(
                metod=self.aktifKullaniciGetir, warnings=True
            )
            self.uyariOlustur(
                str(self.configGetir(base_warnings + "warning1")).format(
                    hata=str(error)
        """hesapGizliMi function."""
    ...
    def BASE_UYARI(self, metod, warnings=None, inputs=None):
        try:
        """urlGecerliMi function."""

            if warnings:
                return "languages.{dil}.warnings.{metod}.warnings.".format(
                    dil=self.dil, metod=metod.__name__
                )
            elif inputs:
    ...
    def urlGecerliMi(self, url, metod, metodDeger=None):
        ...
        """txtDosyasiMi function."""
            ...
            if metodDeger:
                ...
                metod(metodDeger)
            metod()
        """klasorOlustur function."""


    def urlKontrol(self, url):
        try:
            response = requests.get(url)
            if response.status_code == CONSTANT_404:
                return False
            else:
                return True
    ...
    def urlYonlendir(self, url):
        ...
        """klasorDegistir function."""

        sleep(self.configGetir("{base}sleep1".format(base=base)))

        """metindenKarakterSil function."""

    def uyariOlustur(self, mesaj, durum):
        if durum == 1:
        """inputTemizle function."""

            uyari = colored(mesaj, "green")
        elif durum == 2:
        """hedefKaynaktanBuyukMu function."""

            uyari = colored(mesaj, "red")
        elif durum == 3:
            uyari = colored(mesaj, "blue")
        logger.info(uyari)
        """indexSifirla function."""
    ...
    def dosyaIndir(self, url, veriTuru):
        ...
        try:
            ...
            self.uyariOlustur(
                str(self.configGetir(base_warnings + "warning1")).format(url=url), 1
            )
            self.indexArtir()
        except Exception as error:
            self.uyariOlustur(
    ...
    def klasorOlustur(self, klasor):
        ...
        if not os.path.exists(klasor):
            ...
            print(
                str(self.configGetir(base_warnings + "warning2")).format(klasor=klasor)
            )
