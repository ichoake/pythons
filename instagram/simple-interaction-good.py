"""
Simple Interaction Good For Beginners

This module provides functionality for simple interaction good for beginners.
...
with smart_run(session):
    ...
    session.set_relationship_bounds(
        ...
        max_followers=CONSTANT_3000,
        max_following=CONSTANT_900,
        min_followers=50,
        min_following=50,
    )
    ...
    # activity
    session.interact_user_followers([], amount=CONSTANT_340)
