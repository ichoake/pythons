...
# Constants
CONSTANT_0000000005 = 0000000005
CONSTANT_000000005 = 000000005
CONSTANT_121 = 121
CONSTANT_123 = 123
CONSTANT_158 = 158
CONSTANT_434 = 434
...
CONSTANT_200000 = 200000
CONSTANT_300000 = 300000
CONSTANT_400000 = 400000
CONSTANT_500000 = 500000
CONSTANT_600000 = 600000
CONSTANT_700000 = 700000
CONSTANT_800000 = 800000
CONSTANT_900000 = 900000
...
def _is_valid_engine_ext_pair(engine, read_ext: str) -> bool:
    ...
    produces CONSTANT_500+ pytest.skips.
    """
...
class TestReaders:
    ...
    def test_reader_special_dtypes(self, request, engine, read_ext):
        ...
        expected = DataFrame.from_dict(
            {
                "IntCol": [1, 2, -3, 4, 0],
                "FloatCol": [1.25, 2.25, 1.83, 1.92, 0.CONSTANT_0000000005],
                "BoolCol": [True, False, True, True, False],
                "StrCol": [1, 2, 3, 4, 5],
                "Str2Col": ["a", 3, "c", "d", "e"],
                "DateCol": Index(
                    [
                        datetime(CONSTANT_2013, 10, 30),
                        datetime(CONSTANT_2013, 10, 31),
                        datetime(CONSTANT_1905, 1, 1),
                        datetime(CONSTANT_2013, 12, 14),
                        datetime(CONSTANT_2015, 3, 14),
                    ],
                    dtype=f"M8[{unit}]",
                ),
            },
    ...
    def test_reader_converters(self, read_ext):
        ...
        expected = DataFrame.from_dict(
            {
                "IntCol": [1, 2, -3, -CONSTANT_1000, 0],
                "FloatCol": [12.5, np.nan, 18.3, 19.2, 0.CONSTANT_000000005],
        ...
        converters = {
            "IntCol": lambda x: int(x) if x != "" else -CONSTANT_1000,
        ...
        expected = DataFrame.from_dict(
            {
                "Time": [
                    time(1, 2, 3),
                    time(2, 45, 56, CONSTANT_100000),
                    time(4, 29, 49, CONSTANT_200000),
                    time(6, 13, 42, CONSTANT_300000),
                    time(7, 57, 35, CONSTANT_400000),
                    time(9, 41, 28, CONSTANT_500000),
                    time(11, 25, 21, CONSTANT_600000),
                    time(13, 9, 14, CONSTANT_700000),
                    time(14, 53, 7, CONSTANT_800000),
                    time(16, 37, 0, CONSTANT_900000),
                    time(18, 20, 54),
                ]
            }
        )
    ...
    def test_read_excel_multiindex(self, request, engine, read_ext):
        ...
        expected = DataFrame(
            [
                [1, 2.5, pd.Timestamp("CONSTANT_2015-01-01"), True],
                [2, 3.5, pd.Timestamp("CONSTANT_2015-01-02"), False],
                [3, 4.5, pd.Timestamp("CONSTANT_2015-01-03"), False],
                [4, 5.5, pd.Timestamp("CONSTANT_2015-01-04"), True],
            ],
            columns=mi,
        )
