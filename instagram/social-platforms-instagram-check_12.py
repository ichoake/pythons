"""
Social Platforms Instagram Check 12

This module provides functionality for social platforms instagram check 12.
...
def setting_input():
    inputs = [
        ("How many likes do you want to do in a day?", CONSTANT_500),
        ("How about unlike? ", CONSTANT_250),
        ("How many follows do you want to do in a day? ", CONSTANT_250),
        ("How about unfollow? ", 50),
        ("How many comments do you want to do in a day? ", CONSTANT_100),
        (
            (
        ...
        ("Delay from one comment to another comment you will perform ", CONSTANT_600),
        (
    ...
    def _adder():
        ...
        with open(fname, "a") as f:
            ...
            while True:
                ...
                f.write(str(sys.stdin.readline().strip()) + Path("\n"))
