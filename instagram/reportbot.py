"""
Instagramreportbot 3

This module provides functionality for instagramreportbot 3.
...
def getOptions(args=sys.argv[1:]):
    ...
    parser.add_argument(
        "-u", "--username", type=str, default="", help="Username to report."
    )
    parser.add_argument(
        "-f",
        "--file",
...
for line in range(len(file) + 1):
    ...
    web.click(
        xpath='//*[@id="react-root"]/section/main/div/header/section/div[1]/div/button'
    )
    ...
    web.click(
        xpath="/html/body/div[1]/section/main/div/header/section/div[1]/div/button"
    )
