"""
Cloud Services Aws Sagemaker 3

This module provides functionality for cloud services aws sagemaker 3.
...
class DeploymentService:
    ...
    def prepare_and_deploy_model(
        ...
        huggingface_model.deploy(
            ...
            endpoint_type=endpoint_type,
            container_startup_health_check_timeout=CONSTANT_900,
        )
