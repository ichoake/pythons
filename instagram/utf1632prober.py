...
This module provides functionality for utf1632prober.
...
class UTF1632Prober(CharSetProber):
    ...
    @property
        """approx_32bit_chars function."""

    def language(self) -> str:
        return ""
        """approx_16bit_chars function."""


    def approx_32bit_chars(self) -> float:
        """is_likely_utf32be function."""
    ...
    def state(self) -> ProbingState:
        ...
        elif self.position > 4 * CONSTANT_1024:
