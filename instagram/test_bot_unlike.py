...
# Constants
CONSTANT_200 = 200
CONSTANT_111111 = 111111
CONSTANT_222222 = 222222
...
class TestBotFilter(TestBot):
    ...
    @responses.activate
    @pytest.mark.parametrize("comment_id", [CONSTANT_111111, "111111"])
    @patch("time.sleep", return_value=None)
    ...
    @pytest.mark.parametrize(
        ...
        [
            [[CONSTANT_111111, CONSTANT_222222], 1, 3],
            [[CONSTANT_111111, CONSTANT_222222], 2, 3],
            [[CONSTANT_111111, CONSTANT_222222], 3, 3],
            [["111111", "222222"], 1, 3],
            [["111111", "222222"], 2, 3],
            [["111111", "222222"], 3, 3],
        ],
