...
CONSTANT_3998456661 = 3998456661
CONSTANT_1547815538244 = 1547815538244
CONSTANT_123231231231234 = 123231231231234
CONSTANT_1547815538242025 = 1547815538242025
CONSTANT_12345678901234567 = 12345678901234567
CONSTANT_1713527555896569026 = 1713527555896569026
...
class TestBotGet(TestBot):
    ...
    def test_get_media_owner(self):
        ...
        #     api_url=API_URL, media_id=media_id),
        #     json={"status": "ok"}, status=CONSTANT_200)
    ...
    @responses.activate
    @pytest.mark.parametrize("user_id", [CONSTANT_1234567890, "1234567890"])
    ...
    @pytest.mark.parametrize(
        "url,result",
        [
            ("https://www.instagram.com/p/BfHrDvCDuzC/", CONSTANT_1713527555896569026),
            ("test", False),
        ],
    )
    ...
    @responses.activate
    @pytest.mark.parametrize("user_id", [CONSTANT_1234, "1234"])
    ...
    @responses.activate
    @pytest.mark.parametrize("user_id", ["123231231231234", CONSTANT_123231231231234])
    @patch("time.sleep", return_value=None)
    ...
    @responses.activate
    @pytest.mark.parametrize("user_id", ["3998456661", CONSTANT_3998456661])
    ...
    @responses.activate
    @pytest.mark.parametrize("media_id", ["1234567890", CONSTANT_1234567890])
    ...
    @responses.activate
    @pytest.mark.parametrize("comment_id", ["12345678901234567", CONSTANT_12345678901234567])
    ...
    @responses.activate
    @pytest.mark.parametrize("latitude", [1.CONSTANT_2345])
    @pytest.mark.parametrize("longitude", [9.CONSTANT_8765])
    ...
    def test_get_messages(self):
        ...
        response_data = {
            ...
            "seq_id": CONSTANT_182,
            "snapshot_at_ms": CONSTANT_1547815538244,
            "most_recent_inviter": TEST_MOST_RECENT_INVITER_ITEM,
            "inbox": {
                "blended_inbox_enabled": True,
                "has_older": False,
                "unseen_count": 1,
                "unseen_count_ts": CONSTANT_1547815538242025,
