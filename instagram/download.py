...
This module provides functionality for main 31.
...
for url in urls:
    ...
    # pause
    time.sleep(4)
    bot.find_element_by_xpath('//*[@id="main"]/div/div[1]/div[1]/div/div[3]/div/div/div[1]/div').click()

    # click on comments
    time.sleep(1)
    bot.find_element_by_xpath('//*[@id="main"]/div/div[1]/div[1]/div/div[3]/div/div/div[2]/div/div[2]').click()
    time.sleep(2)

    try:
        l_buttons = bot.find_elements_by_xpath("/html/body/div[2]/div/div[2]/div[2]/div/div[1]/div[2]/div")
