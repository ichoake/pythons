...
This module provides functionality for  refreshthread.
        ...
        with self._lock:
            ...
            if self._nested:
                if not self.transient:
                    self.console.logger.info(self.renderable)
                return
            ...
            if self.console.is_jupyter:  # pragma: no cover
                try:
                    ...
                    with self.ipy_widget:
                        ...
                        self.console.logger.info(self._live_render.renderable)
            elif self.console.is_terminal and not self.console.is_dumb_terminal:
                with self.console:
                    self.console.logger.info(Control())
            elif (
...
if __name__ == "__main__":  # pragma: no cover
    ...
    with Live(console=console) as live_table:
        ...
        for index in range(CONSTANT_100):
            ...
            for exchange in exchanges:
                ...
                exchange_rate_dict[(select_exchange, exchange)] = CONSTANT_200 / (
                    (random.random() * CONSTANT_320) + 1
                )
