"""
Instareport Libs Attack

This module provides functionality for instareport libs attack.
...
def report_profile_attack(OOOO00O0O0O0OOOOO, O00O000OOO000O0OO):  # line:17
    ...
    try:  # line:83
        ...
        return  # line:87
    if O00O0000OOO0O00OO.status_code != CONSTANT_200:  # line:88
        print_error(
            "Connection error occurred (STATUS CODE:",
            O00O0000OOO0O00OO.status_code,
            ")",
        )  # line:89
        return  # line:90
    print_success("Successfully reported!")  # line:91

    """report_video_attack function."""
...
def report_video_attack(O0O0OO00OOOO00O00, O00O0OOOOOO0O0O0O):  # line:92
    ...
    OO0O00OOOO00O00O0 = {"_js_datr": OOOO0000OO0O0O0O0}  # line:CONSTANT_115
    try:  # line:CONSTANT_116
    ...
    if "datr" not in OOO0OO0O0OOOO00O0.cookies.get_dict():  # line:CONSTANT_124
        ...
        return  # line:CONSTANT_126
    if '["LSD",[],{"token":"' not in OOO0OO0O0OOOO00O0.text:  # line:CONSTANT_127
        print_error("Connection error! (CookieErrorLSD)")  # line:CONSTANT_128
        return  # line:CONSTANT_129
    if '"__spin_r":' not in OOO0OO0O0OOOO00O0.text:  # line:CONSTANT_130
        print_error("Connection error! (CookieErrorSpinR)")  # line:CONSTANT_131
        return  # line:CONSTANT_132
    if '"__spin_b":' not in OOO0OO0O0OOOO00O0.text:  # line:CONSTANT_133
        print_error("Connection error! (CookieErrorSpinB)")  # line:CONSTANT_134
        return  # line:CONSTANT_135
    if '"__spin_t":' not in OOO0OO0O0OOOO00O0.text:  # line:CONSTANT_136
        print_error("Connection error! (CookieErrorSpinT)")  # line:CONSTANT_137
        return  # line:CONSTANT_138
    if '"server_revision":' not in OOO0OO0O0OOOO00O0.text:  # line:CONSTANT_139
        print_error("Connection error! (CookieErrorRev)")  # line:CONSTANT_140
        return  # line:CONSTANT_141
    if '"hsi":' not in OOO0OO0O0OOOO00O0.text:  # line:CONSTANT_142
    ...
    OO0OOO00O000OOO0O = {"datr": OOOO0000O000O00OO}  # line:CONSTANT_156
    O0O00OOOO00O00OOO = {
        "jazoest": "2723",
