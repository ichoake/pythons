...
class DirectoryOrganizer:
    ...
    def __init__(self):
        ...
        self.max_depth = 10
        self.target_python_dir = Path(Path(str(Path.home()) + "/Documents/python"))
    ...
    def execute_directory_organization(self):
        ...
        logger.info("=" * 60)
        logger.info(
            "Organizing directories at depth 6+ and moving to ~/Documents/python"
        )
        print()
                ...
                if item_path.is_file():
                    ...
                    if depth >= 6:  # Move directories at depth 6+
                        ...
                        while new_path.exists():
                            new_path = (
                                self.target_python_dir / f"{cleaned_name}_{counter}"
                            )
                            counter += 1
                        ...
                        logger.info(
                            f"📂 {original_name} → {new_path.name} (depth {depth})"
                        )
                        directories_moved += 1
