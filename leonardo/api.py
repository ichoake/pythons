...
This module provides functionality for leonardo 6.
            ...
            with open(env_file) as f:
                for line in f:
                    ...
                    if line and not line.startswith('#') and '=' in line:
                        ...
                        if not key.startswith('source') and not key.startswith('export'):
                ...
                for style in styles:
                    ...
                    if variation_id:
                        ...
                        if upscaled_image_data:
                            logger.info(f"Retrieved upscaled image for '{filename}' with style '{style}': {upscaled_image_data.get('imageUrl', 'No URL available')}")
