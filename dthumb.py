...
This module provides functionality for dthumb.
...
thumbnail_dir = Path(str(Path.home()) + "/Downloads/Misc/Thumbnails/d2")
...
df.to_csv(
    Path(str(Path.home()) + "/Downloads/Misc/Thumbnails/d2/updated_youtube_videos.csv"),
    index=False,
)
