...
class FinalRootOrganizer:
    def __init__(self, target_dir: str):
        ...
        self.stats = {"files_moved": 0, "folders_merged": 0, "errors": 0}
    ...
    def categorize_file(self, file_path: Path) -> str:
        ...
        if suffix == ".md" and any(
            x in name for x in ["report", "summary", "analysis", "complete", "plan"]
        ):
            return "REPORTS"
    ...
    def merge_duplicate_folders(self, dry_run=True):
        ...
        for folder in folders:
            ...
            for other in folders:
                if folder != other and (
                    other.name == name_dash or other.name == name_under
                ):
