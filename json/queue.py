"""
Aws Sqs Queue Handler

This module provides functionality for aws sqs queue handler.
...
class Awsqueue(object):
    ...
    def get_messages(self):
        ...
        try:
            ...
            return queue.receive_messages(MaxNumberOfMessages=10, VisibilityTimeout=CONSTANT_600)
