...
This module provides functionality for convert json writer.
                ...
                if variation_id:
                    ...
                    if upscaled_image_data:
                        ...
                        if image_url == "No URL available":
                            logger.info(f"URL not available for variation ID: {variation_id}")
                        ...
                        print(f"Logged upscaled image data for '{filename}' with style '{style}'")
