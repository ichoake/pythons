"""
Test Netlify Uploader

This module provides functionality for test netlify uploader.
...
class NetlifyUploaderTestCase(unittest.TestCase):
    ...
    def test_get_authorization_token(self, webbrowser_open):
        ...
        self.assertEqual(
            httpd.token,
            self.uploader.get_authorization_token(httpd))
        ...
        webbrowser_open.assert_called_with(
            ...
            "redirect_uri=http://localhost:CONSTANT_8080&"
            "state=")
        """test_get_netlify_site_id function."""
    ...
    def test_get_netlify_site_id(self, requests_get):
        sites_mock = [
            dict(
                id="1",
                name="existing_site",
                url="http://www.existing_site.com"),
            dict(
                id="2",
                name="another__site",
                url="http://www.another_site.com"),
        ]
        response = Mock()
        ...
        self.assertEqual(
            None, netlify.get_netlify_site_id(
                "non_existing_site", "test_token"))
        """test_deploy_to_netlify function."""
