...
class CleanupOrchestrator:
    ...
    def run_analysis(self):
        ...
        try:
            result = subprocess.run(
                [sys.executable, "Documents_Analyzer_Robust.py"], cwd=self.root_path, capture_output=True, text=True
            )
    ...
    def create_cleanup_summary(self):
        ...
        summary = {
            ...
            "reports_found": {"general_cleanup": len(cleanup_reports), "python_cleanup": len(python_reports)},
        }
