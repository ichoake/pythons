    ...
    def analyze_content_themes(self):
        ...
        themes = {
            ...
            "animals_pets": {
                ...
                "subthemes": ["funny_animals", "cute_pets", "animal_patterns", "animal_quotes", "pet_mom", "pet_dad"],
            },
            "sublimation_designs": {
                "keywords": ["sublimation", "mug", "tumbler", "20oz", "30oz", "coaster", "tote", "shirt", "hoodie"],
                "subthemes": ["mugs", "tumblers", "apparel", "accessories", "home_decor"],
            },
            "patterns_seamless": {
                "keywords": ["pattern", "seamless", "repeat", "texture", "background", "tile"],
                "subthemes": ["geometric", "nature", "abstract", "floral", "vintage", "modern"],
            },
            "typography_quotes": {
                "keywords": [
                    "quote",
                ...
                "subthemes": ["funny_quotes", "motivational", "sarcastic", "inspirational", "wedding", "birthday"],
            },
            "seasonal_events": {
                "keywords": [
                    "valentine",
    ...
    def analyze_project_structure(self):
        ...
        for item in self.root_path.iterdir():
            if item.is_dir() and not item.name.startswith("00_"):
                ...
                if any(word in item.name.lower() for word in ["bundle", "collection", "pack"]):
                ...
                if any(word in item.name.lower() for word in ["design", "graphic", "art", "creative"]):
                    project_info["content_type"] = "design"
                    projects["design_projects"].append(project_info)

                # Check for template projects
                if any(word in item.name.lower() for word in ["template", "mockup", "psd"]):
                ...
                if any(word in item.name.lower() for word in ["marketing", "promo", "social", "tiktok", "instagram"]):
    ...
    def create_intelligent_organization(self):
        ...
        org_structure = {
            "01_Active_Projects": {
                ...
                "subdirs": ["Gallery_Projects", "Bundle_Projects", "Design_Projects", "Template_Projects"],
            },
            ...
            "03_Quality_Resolutions": {
                ...
                "subdirs": ["High_Resolution_300dpi", "Standard_Resolution", "Thumbnails", "Web_Optimized"],
            },
            "04_Business_Assets": {
                "description": "Business and marketing related files",
                "subdirs": ["Marketing_Materials", "Templates", "Brand_Assets", "Analytics_Data"],
            },
            "05_Archives": {
                "description": "Completed projects and archived content",
                "subdirs": ["Completed_Projects", "Old_Versions", "Backup_Files", "ZIP_Archives"],
            },
            "06_System_Files": {
                "description": "System and utility files",
                "subdirs": ["CSS_Files", "JavaScript_Files", "JSON_Data", "Documentation"],
            },
        }
...
def main():
    ...
    logger.info("Your original files remain untouched - this creates a smart navigation system!")
