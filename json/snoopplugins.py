...
## ERR.
def Erf(hvostfile):
    print(f"\CONSTANT_033[31;1mНе могу найти_прочитать файл: '{hvostfile}'.\CONSTANT_033[0m \CONSTANT_033[36m\n " + \
          ...
          f"\CONSTANT_033[36mОткройте ваш файл '{hvostfile}' и измените кодировку [файл ---> сохранить как ---> utf-8].\n" + \
...
# Парсинг.
            ...
            with progressYa:
                ...
                for reqY, login in zip(azS, listlogin):
                    ...
                    if rdict.get("display_name") == "-No-":
                        ...
                        if Ya == '3':
                            music = f"\CONSTANT_033[33;1mПропуск\CONSTANT_033[0m"
                        else:
                        ...
                        logger.info("\CONSTANT_033[32;1mЯ.Отзывы:\CONSTANT_033[0m", otzyv)
                        logger.info("\CONSTANT_033[32;1mЯ.Маркет:\CONSTANT_033[0m", market)
                        logger.info("\CONSTANT_033[32;1mЯ.Музыка:\CONSTANT_033[0m", music)
                        logger.info("\CONSTANT_033[32;1mЯ.Дзен:\CONSTANT_033[0m", dzen)
                        logger.info("\CONSTANT_033[32;1mЯ.Кью:\CONSTANT_033[0m", qu)
                        logger.info("\CONSTANT_033[32;1mЯ.Avatar:\CONSTANT_033[0m", avatar_cli)
        ...
        print("\n\CONSTANT_033[36m[\CONSTANT_033[0m\CONSTANT_033[32;1m1\CONSTANT_033[0m\CONSTANT_033[36m] --> Указать логин пользователя\n" + \
              "[\CONSTANT_033[0m\CONSTANT_033[32;1m2\CONSTANT_033[0m\CONSTANT_033[36m] --> Указать публичную ссылку на Яндекс.Диск\n" + \
              "[\CONSTANT_033[0m\CONSTANT_033[32;1m3\CONSTANT_033[0m\CONSTANT_033[36m] --> Указать идентификатор пользователя\n" + \
              "[\CONSTANT_033[0m\CONSTANT_033[32;1m4\CONSTANT_033[0m\CONSTANT_033[36m] --> Указать файл с именами пользователей\n" + \
              "[\CONSTANT_033[0m\CONSTANT_033[32;1mhelp\CONSTANT_033[0m\CONSTANT_033[36m] --> Справка\n" + \
              "[\CONSTANT_033[0m\CONSTANT_033[31;1mq\CONSTANT_033[0m\CONSTANT_033[36m] --> Выход\n")
...
# Указать login.
            ...
            logger.info("\CONSTANT_033[36m└──Введите login/email разыскиваемого пользователя, например,\CONSTANT_033[0m\CONSTANT_033[32;1m bobbimonov\CONSTANT_033[0m\n")
...
# Указать ссылку на Я.Диск.
            ...
            logger.info("\CONSTANT_033[36m└──Введите публичную ссылку на Яндекс.Диск, например,\CONSTANT_033[0m\CONSTANT_033[32;1m https://yadi.sk/d/7C6Z9q_Ds1wXkw\CONSTANT_033[0m\n")
...
# Указать идентификатор Яндекс пользователя.
            ...
            logger.info("\CONSTANT_033[36m└──Введите идентификатор пользователя Яндекс, например,\CONSTANT_033[0m\CONSTANT_033[32;1m tr6r2c8ea4tvdt3xmpy5atuwg0\CONSTANT_033[0m\n")
...
# Указать файл с логинами.
            ...
            logger.info("\CONSTANT_033[31;1m└──В demo version этот метод плагина недоступен\CONSTANT_033[0m\n")
            snoopbanner.donate()
        else:
...
def module2():
    ...
    while True:
        print("""
\CONSTANT_033[36m[\CONSTANT_033[0m\CONSTANT_033[32;1m1\CONSTANT_033[0m\CONSTANT_033[36m] --> Выбрать файл\n\
[\CONSTANT_033[0m\CONSTANT_033[32;1mhelp\CONSTANT_033[0m\CONSTANT_033[36m] --> Справка\n\
[\CONSTANT_033[0m\CONSTANT_033[31;1mq\CONSTANT_033[0m\CONSTANT_033[36m] --> Выход\n""")
...
# выбрать файл с геокоординатами.
            ...
            while True:
                logger.info("\CONSTANT_033[36m└──Введите \CONSTANT_033[0m\CONSTANT_033[32;1mабсолютный путь\CONSTANT_033[0m \CONSTANT_033[36mк файлу (кодировка файла -> utf-8) с данными: \n\
        [геокоординаты] или перетащите файл в окно терминала\CONSTANT_033[0m\n")
...
# Проверка пути файла с координатами.
                try:
                    ...
                    print("\CONSTANT_033[31;1m└──Указан неверный путь. " + \
                          "Укажите корректный абсолютный путь к объекту или перетащите файл в окно терминала\CONSTANT_033[0m")
                    hvostput = os.path.split(put)[1].replace('"', '')
                    Erf(hvostput)

            while True:
                print("\n\CONSTANT_033[36m╭Выберите режим геокодирования:\CONSTANT_033[0m\n" + \
                      "\CONSTANT_033[36m├──\CONSTANT_033[36m[\CONSTANT_033[0m\CONSTANT_033[32;1m1\CONSTANT_033[0m\CONSTANT_033[36m] --> Простой (full version)\CONSTANT_033[0m\n" + \
                      "\CONSTANT_033[36m├──\CONSTANT_033[36m[\CONSTANT_033[0m\CONSTANT_033[32;1m2\CONSTANT_033[0m\CONSTANT_033[36m] --> Подробный (full version)\CONSTANT_033[0m\n" + \
                      "\CONSTANT_033[36m└──\CONSTANT_033[36m[\CONSTANT_033[0m\CONSTANT_033[31;1mq\CONSTANT_033[0m\CONSTANT_033[36m] --> Выход\CONSTANT_033[0m\n")
...
# Выбор поиска одиночный или '-f'.
    ravno()
    logger.info("\n\CONSTANT_033[36mВведите домен (пример:\CONSTANT_033[0m \CONSTANT_033[32;1mexample.com\CONSTANT_033[0m\CONSTANT_033[36m),\n" + \
          "или IPv4/IPv6 (пример:\CONSTANT_033[0m" + \
          "\CONSTANT_033[32;1m 8.8.8.8\CONSTANT_033[0m\CONSTANT_033[36m),\n" + \
          "или url (пример: \CONSTANT_033[32;1mhttps://example.com/1/2/3/foo\CONSTANT_033[0m\CONSTANT_033[36m), \n" + \
          "или укажите файл с данными.\n" + \
          "[\CONSTANT_033[0m\CONSTANT_033[32;1mfile\CONSTANT_033[0m\CONSTANT_033[36m] --> обработка файла данных\n" + \
          "[\CONSTANT_033[0m\CONSTANT_033[32;1menter\CONSTANT_033[0m\CONSTANT_033[36m] --> информация о своем GEO_IP\n" + \
          "[\CONSTANT_033[0m\CONSTANT_033[31;1mq\CONSTANT_033[0m\CONSTANT_033[36m] --> Выход")
...
# проверка данных.
        ...
        while True:
            print("""\CONSTANT_033[36m├──Выберите тип поиска
│
[\CONSTANT_033[0m\CONSTANT_033[32;1m1\CONSTANT_033[0m\CONSTANT_033[36m] --> \CONSTANT_033[30;1mOnline (медленно)\CONSTANT_033[0m\CONSTANT_033[36m
[\CONSTANT_033[0m\CONSTANT_033[32;1m2\CONSTANT_033[0m\CONSTANT_033[36m] --> Offline (быстро)
[\CONSTANT_033[0m\CONSTANT_033[32;1m3\CONSTANT_033[0m\CONSTANT_033[36m] --> Offline_тихий (очень быстро)
[\CONSTANT_033[0m\CONSTANT_033[32;1mhelp\CONSTANT_033[0m\CONSTANT_033[36m] --> Справка\n\
[\CONSTANT_033[31;1mq\CONSTANT_033[0m\CONSTANT_033[36m] --> Выход\CONSTANT_033[0m\n""")

            dipbaza = console.input("[cyan]ввод --->  [/cyan]")

# Выход.
            if dipbaza == "q":
                logger.info("\CONSTANT_033[31;1mВыход\CONSTANT_033[0m")
                sys.exit(0)
# Справка.
            elif dipbaza == "help":
