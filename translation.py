...
-------
Plan: FREE
Filesize limit: CONSTANT_1500 MB
...
URL | filename | username | password"""
    ...
    NOT_AUTH_USER_TEXT = (
        "You Aren't An Approved User Please must Upgrade the plan /upgrade."
    )
    ...
    SAVED_CUSTOM_THUMB_NAIL = (
        "Custom thumbnail saved. This image will be used in the video / file."
    )
...
Send /me to know current plan details"""
    REPLY_TO_DOC_GET_LINK = (
        "Reply to a Telegram media to get High Speed Direct Download Link 😌"
    )
    ...
    USER_DELETED_FROM_DB = (
        "User <a href='tg://user?id={}'>{}</a> deleted from DataBase 🤷‍♀️."
    )
    ...
    EXTRACT_ZIP_ERRS_OCCURED = "Sorry. Errors occurred while processing compressed file. Please check everything again twice, and if the issue persists, report this to <a href='https://telegram.dog/redbullfed'>MwK Tech Support Group</a>"
    EXTRACT_ZIP_STEP_TWO = """Select file_name to upload from the below options 😌.
You can use /rename command after receiving file to rename it with custom thumbnail support."""
    GET_LINK_ERRS_OCCURED = "Sorry the following Errors occurred: \n{}\nPlease check everything again twice, and if the issue persists, report this to <a href='https://telegram.dog/redbullfed'>Mwk Tech Support Group</a>"
    CANCEL_STR = "Process Cancelled 🙇‍♀️"
    ZIP_UPLOADED_STR = "Uploaded {} files in {} seconds"
    FREE_USER_LIMIT_Q_SZE = """Cannot Process 😔.
Free users only 1 request per 30 minutes.
/upgrade or Try CONSTANT_1800 seconds later."""
    ...
    FED_UP_WITH_CRAP = "This bot is no longer leeching links for free users. @TG_MegaBot is open source, and you can deploy your own telegram upload by clicking on the links, available in <a href='https://github.com/shamilhabeebnelli/TG-MegaBot>GitHub README</a>. or, Better /upgrade the subscription to continue using this bot."
