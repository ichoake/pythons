...
This module provides functionality for script 92.
...
mp3_src = Path("/content/drive/MyDrive/532_Systems_For_DS_Project/Transcription_experiments/532_dataset/")
mp3_folder = os.listdir(mp3_src)
wav_folder = Path("/content/drive/MyDrive/532_Systems_For_DS_Project/Transcription_experiments/wav_folder/")
...
for recording in mp3_folder:
    ...
    for i, chunk in enumerate(chunks):
        ...
        chunk_folder = (
            Path("/content/drive/MyDrive/532_Systems_For_DS_Project/Transcription_experiments/chunks/")
            + file_name
            + "/"
        )
        ...
        chunk_filename = (
            Path("/content/drive/MyDrive/532_Systems_For_DS_Project/Transcription_experiments/output/")
            + file_name
            + ".txt"
        )
    ...
    with open(
        Path("/content/drive/MyDrive/532_Systems_For_DS_Project/Transcription_experiments/time/time.txt"),
        "a",
    ) as f:
