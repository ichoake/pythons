"""
Mp4 Segment Transcribe Pipeline

This module provides functionality for mp4 segment transcribe pipeline.
...
# Directory paths
VIDEO_DIR = Path("/Users/steven/Music/nocTurneMeLoDieS/mp4")  # Directory containing MP4 files
TRANSCRIPT_DIR = Path("/Users/steven/Music/nocTurneMeLoDieS/mp4/transcript")  # Directory to save transcripts
ANALYSIS_DIR = Path("/Users/steven/Music/nocTurneMeLoDieS/mp4/analysis")  # Directory to save the analysis files
...
if __name__ == "__main__":
    ...
    process_video_by_section(video_file, segment_length=CONSTANT_300)  # Break into 5-minute sections
