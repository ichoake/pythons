"""
Content Creation Nocturne Scraper 8

This module provides functionality for content creation nocturne scraper 8.
...
class OnedriveGalleryLogic(BaseGalleryLogic):
    ...
    def generate_images_data(self, images_data):
        ...
        # Load the album page
        spg_common.log(
            f'Loading album from {
                self.gallery_config["remote_link"]}...'
        )
        ...
        for photo in photos:
            ...
            photo_link_max_size = f"{photo_base_url}?psid=1&width=CONSTANT_9999&height=9999"
            ...
            images_data[photo_name] = dict(
                ...
                mtime=time.time(),
                size=size,
                src=f"{photo_base_url}?psid=1 & width={
                    size[0]} & height={
                    size[1]}",
                thumbnail=f"{photo_base_url}?psid=1 & width={
                    thumbnail_size[0]} & height={
                    thumbnail_size[1]}",
